...
mui_sampler_gauss_3t* mui_create_sampler_gauss_3t( double r, double h ) {
  return new mui_sampler_gauss_3t( static_cast<mui::mui_c_wrapper_3D::REAL>(r), static_cast<mui::mui_c_wrapper_3D::REAL>(h) );
}
...
mui_sampler_rbf_3f* mui_create_sampler_rbf_3f( float r, mui_point_3f* points, int points_count,
  ...
  return new mui_sampler_rbf_3f( r, pts, basis_func, static_cast<bool>(conservative), static_cast<bool>(polynomial), static_cast<bool>(smoothFunc),
                                 static_cast<bool>(readMatrix), std::string(file_address), cutoff );
}

mui_sampler_rbf_3fx* mui_create_sampler_rbf_3fx( float r, mui_point_3fx* points, int points_count,
                                                 int basis_func, int conservative, int polynomial, int smoothFunc, int readMatrix,
                                                 const char* file_address, float cutoff ) {
  ...
  return new mui_sampler_rbf_3fx( r, pts, basis_func, static_cast<bool>(conservative), static_cast<bool>(polynomial), static_cast<bool>(smoothFunc),
                                  static_cast<bool>(readMatrix), std::string(file_address), cutoff );
}

mui_sampler_rbf_3d* mui_create_sampler_rbf_3d( double r, mui_point_3d* points, int points_count,
                                               int basis_func, int conservative, int polynomial, int smoothFunc, int readMatrix,
  ...
  return new mui_sampler_rbf_3d( r, pts, basis_func, static_cast<bool>(conservative), static_cast<bool>(polynomial), static_cast<bool>(smoothFunc),
                                 static_cast<bool>(readMatrix), std::string(file_address), cutoff );
}

mui_sampler_rbf_3dx* mui_create_sampler_rbf_3dx( double r, mui_point_3dx* points, int points_count,
                                                 int basis_func, int conservative, int polynomial, int smoothFunc, int readMatrix,
                                                 const char* file_address, double cutoff ) {
  ...
  return new mui_sampler_rbf_3dx( r, pts, basis_func, static_cast<bool>(conservative), static_cast<bool>(polynomial), static_cast<bool>(smoothFunc),
                                  static_cast<bool>(readMatrix), std::string(file_address), cutoff );
}

mui_sampler_rbf_3t* mui_create_sampler_rbf_3t( double r, mui_point_3t* points, int points_count, int basis_func, int conservative,
  ...
  return new mui_sampler_rbf_3t( static_cast<mui::mui_c_wrapper_3D::REAL>(r), pts, basis_func, static_cast<bool>(conservative), static_cast<bool>(polynomial),
                                 static_cast<bool>(smoothFunc), static_cast<bool>(readMatrix), std::string(file_address), static_cast<mui::mui_c_wrapper_3D::REAL>(cutoff) );
}
#endif
...
mui_chrono_sampler_gauss_3t* mui_create_chrono_sampler_gauss_3t( double cutoff, double sigma ) {
  return new mui_chrono_sampler_gauss_3t( static_cast<mui::mui_c_wrapper_3D::time_type>(cutoff), static_cast<mui::mui_c_wrapper_3D::REAL>(sigma) );
}
...
mui_chrono_sampler_mean_3t* mui_create_chrono_sampler_mean_3t( double lower, double upper ) {
  return new mui_chrono_sampler_mean_3t( static_cast<mui::mui_c_wrapper_3D::time_type>(lower), static_cast<mui::mui_c_wrapper_3D::time_type>(upper) );
}
...
mui_chrono_sampler_sum_3t* mui_create_chrono_sampler_sum_3t( double lower, double upper ) {
  return new mui_chrono_sampler_sum_3t( static_cast<mui::mui_c_wrapper_3D::time_type>(lower), static_cast<mui::mui_c_wrapper_3D::time_type>(upper) );
}
...
void mui_commit_3t_pair( mui_uniface_3t* uniface, double t_1, double t_2 ) {
  uniface->commit( static_cast<mui::mui_c_wrapper_3D::time_type>(t_1), static_cast<mui::mui_c_wrapper_3D::time_type>(t_2) );
}
...
void mui_forecast_3t_pair( mui_uniface_3t* uniface, double t_1, double t_2 ) {
  uniface->forecast( static_cast<mui::mui_c_wrapper_3D::time_type>(t_1), static_cast<mui::mui_c_wrapper_3D::time_type>(t_2) );
}
...
float mui_fetch_exact_exact_3f( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t,
  ...
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t, *spatial_sampler, *temporal_sampler );
}
...
float mui_fetch_exact_exact_3fx( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t,
  ...
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t, *spatial_sampler, *temporal_sampler );
}
...
double mui_fetch_exact_exact_3d( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t,
  ...
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t, *spatial_sampler, *temporal_sampler );
}
...
double mui_fetch_exact_exact_3dx( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t,
  ...
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t, *spatial_sampler, *temporal_sampler );
}
...
double mui_fetch_exact_exact_3t( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t,
  ...
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_3D::time_type>(t),
...
float mui_fetch_pseudo_nearest_neighbor_exact_3fx( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t,
                                                   mui_sampler_pseudo_nearest_neighbor_3fx* spatial_sampler, mui_chrono_sampler_exact_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_exact_3d( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t,
                                                   mui_sampler_pseudo_nearest_neighbor_3d* spatial_sampler, mui_chrono_sampler_exact_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_exact_3dx( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t,
                                                    mui_sampler_pseudo_nearest_neighbor_3dx* spatial_sampler, mui_chrono_sampler_exact_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_exact_3t( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t,
                                                   mui_sampler_pseudo_nearest_neighbor_3t* spatial_sampler, mui_chrono_sampler_exact_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_3D::time_type>(t),
...
float mui_fetch_pseudo_nearest_neighbor_gauss_3fx( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t,
                                                   mui_sampler_pseudo_nearest_neighbor_3fx* spatial_sampler, mui_chrono_sampler_gauss_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_gauss_3d( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t,
                                                   mui_sampler_pseudo_nearest_neighbor_3d* spatial_sampler, mui_chrono_sampler_gauss_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_gauss_3dx( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t,
                                                    mui_sampler_pseudo_nearest_neighbor_3dx* spatial_sampler, mui_chrono_sampler_gauss_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_gauss_3t( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t,
                                                   mui_sampler_pseudo_nearest_neighbor_3t* spatial_sampler, mui_chrono_sampler_gauss_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_3D::time_type>(t),
...
float mui_fetch_pseudo_nearest_neighbor_mean_3fx( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t,
                                                  mui_sampler_pseudo_nearest_neighbor_3fx* spatial_sampler, mui_chrono_sampler_mean_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_mean_3d( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t,
                                                  mui_sampler_pseudo_nearest_neighbor_3d* spatial_sampler, mui_chrono_sampler_mean_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_mean_3dx( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t,
                                                   mui_sampler_pseudo_nearest_neighbor_3dx* spatial_sampler, mui_chrono_sampler_mean_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_mean_3t( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t,
                                                  mui_sampler_pseudo_nearest_neighbor_3t* spatial_sampler, mui_chrono_sampler_mean_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_3D::time_type>(t),
...
float mui_fetch_pseudo_nearest_neighbor_sum_3fx( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t,
                                                 mui_sampler_pseudo_nearest_neighbor_3fx* spatial_sampler, mui_chrono_sampler_sum_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t, *spatial_sampler, *temporal_sampler );
}
...
double mui_fetch_pseudo_nearest_neighbor_sum_3dx( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t,
                                                  mui_sampler_pseudo_nearest_neighbor_3dx* spatial_sampler, mui_chrono_sampler_sum_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t, *spatial_sampler, *temporal_sampler );
}
...
float mui_fetch_exact_exact_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                mui_sampler_exact_3f* spatial_sampler, mui_chrono_sampler_exact_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_exact_exact_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                      mui_sampler_exact_3fx* spatial_sampler, mui_chrono_sampler_exact_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_exact_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                      mui_sampler_exact_3d* spatial_sampler, mui_chrono_sampler_exact_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_exact_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                       mui_sampler_exact_3dx* spatial_sampler, mui_chrono_sampler_exact_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_exact_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                      mui_sampler_exact_3t* spatial_sampler, mui_chrono_sampler_exact_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_3D::time_type>(t_1),
                                      static_cast<mui::mui_c_wrapper_3D::time_type>(t_2), *spatial_sampler, *temporal_sampler ));
  return result;
}
...
float mui_fetch_exact_gauss_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                      mui_sampler_exact_3fx* spatial_sampler, mui_chrono_sampler_gauss_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_gauss_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                      mui_sampler_exact_3d* spatial_sampler, mui_chrono_sampler_gauss_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_gauss_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                       mui_sampler_exact_3dx* spatial_sampler, mui_chrono_sampler_gauss_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_gauss_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                      mui_sampler_exact_3t* spatial_sampler, mui_chrono_sampler_gauss_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
float mui_fetch_exact_mean_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                     mui_sampler_exact_3fx* spatial_sampler, mui_chrono_sampler_mean_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_mean_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                     mui_sampler_exact_3d* spatial_sampler, mui_chrono_sampler_mean_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_mean_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                      mui_sampler_exact_3dx* spatial_sampler, mui_chrono_sampler_mean_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_mean_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                     mui_sampler_exact_3t* spatial_sampler, mui_chrono_sampler_mean_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
float mui_fetch_exact_sum_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                    mui_sampler_exact_3fx* spatial_sampler, mui_chrono_sampler_sum_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_sum_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                    mui_sampler_exact_3d* spatial_sampler, mui_chrono_sampler_sum_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_sum_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                     mui_sampler_exact_3dx* spatial_sampler, mui_chrono_sampler_sum_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_sum_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                    mui_sampler_exact_3t* spatial_sampler, mui_chrono_sampler_sum_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
float mui_fetch_gauss_exact_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                      mui_sampler_gauss_3fx* spatial_sampler, mui_chrono_sampler_exact_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_exact_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                      mui_sampler_gauss_3d* spatial_sampler, mui_chrono_sampler_exact_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_exact_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                       mui_sampler_gauss_3dx* spatial_sampler, mui_chrono_sampler_exact_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_exact_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                      mui_sampler_gauss_3t* spatial_sampler, mui_chrono_sampler_exact_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
float mui_fetch_gauss_gauss_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                      mui_sampler_gauss_3fx* spatial_sampler, mui_chrono_sampler_gauss_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_gauss_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                      mui_sampler_gauss_3d* spatial_sampler, mui_chrono_sampler_gauss_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_gauss_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                       mui_sampler_gauss_3dx* spatial_sampler, mui_chrono_sampler_gauss_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_gauss_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                      mui_sampler_gauss_3t* spatial_sampler, mui_chrono_sampler_gauss_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
float mui_fetch_gauss_mean_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                     mui_sampler_gauss_3fx* spatial_sampler, mui_chrono_sampler_mean_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_mean_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                     mui_sampler_gauss_3d* spatial_sampler, mui_chrono_sampler_mean_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_mean_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                      mui_sampler_gauss_3dx* spatial_sampler, mui_chrono_sampler_mean_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_mean_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                     mui_sampler_gauss_3t* spatial_sampler, mui_chrono_sampler_mean_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: moving average; temporal sampler: exact
float mui_fetch_moving_average_exact_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                              mui_sampler_moving_average_3f* spatial_sampler, mui_chrono_sampler_exact_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_moving_average_exact_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                               mui_sampler_moving_average_3fx* spatial_sampler, mui_chrono_sampler_exact_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_exact_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                               mui_sampler_moving_average_3d* spatial_sampler, mui_chrono_sampler_exact_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_exact_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                                mui_sampler_moving_average_3dx* spatial_sampler, mui_chrono_sampler_exact_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_exact_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                               mui_sampler_moving_average_3t* spatial_sampler, mui_chrono_sampler_exact_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: moving average; temporal sampler: gauss
float mui_fetch_moving_average_gauss_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                              mui_sampler_moving_average_3f* spatial_sampler, mui_chrono_sampler_gauss_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_moving_average_gauss_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                               mui_sampler_moving_average_3fx* spatial_sampler, mui_chrono_sampler_gauss_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_gauss_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                               mui_sampler_moving_average_3d* spatial_sampler, mui_chrono_sampler_gauss_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_gauss_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                                mui_sampler_moving_average_3dx* spatial_sampler, mui_chrono_sampler_gauss_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_gauss_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                               mui_sampler_moving_average_3t* spatial_sampler, mui_chrono_sampler_gauss_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: moving average; temporal sampler: mean
float mui_fetch_moving_average_mean_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                             mui_sampler_moving_average_3f* spatial_sampler, mui_chrono_sampler_mean_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_moving_average_mean_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                              mui_sampler_moving_average_3fx* spatial_sampler, mui_chrono_sampler_mean_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_mean_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                              mui_sampler_moving_average_3d* spatial_sampler, mui_chrono_sampler_mean_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_mean_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                               mui_sampler_moving_average_3dx* spatial_sampler, mui_chrono_sampler_mean_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_mean_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                              mui_sampler_moving_average_3t* spatial_sampler, mui_chrono_sampler_mean_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: moving average; temporal sampler: sum
float mui_fetch_moving_average_sum_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                            mui_sampler_moving_average_3f* spatial_sampler, mui_chrono_sampler_sum_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_moving_average_sum_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                             mui_sampler_moving_average_3fx* spatial_sampler, mui_chrono_sampler_sum_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_sum_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                             mui_sampler_moving_average_3d* spatial_sampler, mui_chrono_sampler_sum_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_sum_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                              mui_sampler_moving_average_3dx* spatial_sampler, mui_chrono_sampler_sum_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_sum_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                             mui_sampler_moving_average_3t* spatial_sampler, mui_chrono_sampler_sum_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: nearest neighbor; temporal sampler: exact
float mui_fetch_nearest_neighbor_exact_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                                mui_sampler_nearest_neighbor_3f* spatial_sampler, mui_chrono_sampler_exact_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_nearest_neighbor_exact_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                                 mui_sampler_nearest_neighbor_3fx* spatial_sampler, mui_chrono_sampler_exact_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_exact_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                                 mui_sampler_nearest_neighbor_3d* spatial_sampler, mui_chrono_sampler_exact_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_exact_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                                  mui_sampler_nearest_neighbor_3dx* spatial_sampler, mui_chrono_sampler_exact_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_exact_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                                 mui_sampler_nearest_neighbor_3t* spatial_sampler, mui_chrono_sampler_exact_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: nearest neighbor; temporal sampler: gauss
float mui_fetch_nearest_neighbor_gauss_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                                mui_sampler_nearest_neighbor_3f* spatial_sampler, mui_chrono_sampler_gauss_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_nearest_neighbor_gauss_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                                 mui_sampler_nearest_neighbor_3fx* spatial_sampler, mui_chrono_sampler_gauss_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_gauss_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                                 mui_sampler_nearest_neighbor_3d* spatial_sampler, mui_chrono_sampler_gauss_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_gauss_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                                  mui_sampler_nearest_neighbor_3dx* spatial_sampler, mui_chrono_sampler_gauss_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_gauss_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                                 mui_sampler_nearest_neighbor_3t* spatial_sampler, mui_chrono_sampler_gauss_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: nearest neighbor; temporal sampler: mean
float mui_fetch_nearest_neighbor_mean_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                               mui_sampler_nearest_neighbor_3f* spatial_sampler, mui_chrono_sampler_mean_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_nearest_neighbor_mean_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                                mui_sampler_nearest_neighbor_3fx* spatial_sampler, mui_chrono_sampler_mean_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_mean_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                                mui_sampler_nearest_neighbor_3d* spatial_sampler, mui_chrono_sampler_mean_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_mean_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                                 mui_sampler_nearest_neighbor_3dx* spatial_sampler, mui_chrono_sampler_mean_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_mean_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                                mui_sampler_nearest_neighbor_3t* spatial_sampler, mui_chrono_sampler_mean_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: nearest neighbor; temporal sampler: sum
float mui_fetch_nearest_neighbor_sum_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                              mui_sampler_nearest_neighbor_3f* spatial_sampler, mui_chrono_sampler_sum_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_nearest_neighbor_sum_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                               mui_sampler_nearest_neighbor_3fx* spatial_sampler, mui_chrono_sampler_sum_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_sum_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                               mui_sampler_nearest_neighbor_3d* spatial_sampler, mui_chrono_sampler_sum_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_sum_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                                mui_sampler_nearest_neighbor_3dx* spatial_sampler, mui_chrono_sampler_sum_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_sum_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                               mui_sampler_nearest_neighbor_3t* spatial_sampler, mui_chrono_sampler_sum_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: nearest neighbor; temporal sampler: exact
float mui_fetch_pseudo_nearest_neighbor_exact_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                                       mui_sampler_pseudo_nearest_neighbor_3f* spatial_sampler, mui_chrono_sampler_exact_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_pseudo_nearest_neighbor_exact_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                                        mui_sampler_pseudo_nearest_neighbor_3fx* spatial_sampler, mui_chrono_sampler_exact_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_exact_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                                        mui_sampler_pseudo_nearest_neighbor_3d* spatial_sampler, mui_chrono_sampler_exact_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_exact_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                                         mui_sampler_pseudo_nearest_neighbor_3dx* spatial_sampler, mui_chrono_sampler_exact_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_exact_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                                        mui_sampler_pseudo_nearest_neighbor_3t* spatial_sampler, mui_chrono_sampler_exact_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: nearest neighbor; temporal sampler: gauss
float mui_fetch_pseudo_nearest_neighbor_gauss_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                                       mui_sampler_pseudo_nearest_neighbor_3f* spatial_sampler, mui_chrono_sampler_gauss_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_pseudo_nearest_neighbor_gauss_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                                        mui_sampler_pseudo_nearest_neighbor_3fx* spatial_sampler, mui_chrono_sampler_gauss_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_gauss_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                                        mui_sampler_pseudo_nearest_neighbor_3d* spatial_sampler, mui_chrono_sampler_gauss_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_gauss_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                                         mui_sampler_pseudo_nearest_neighbor_3dx* spatial_sampler, mui_chrono_sampler_gauss_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_gauss_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                                        mui_sampler_pseudo_nearest_neighbor_3t* spatial_sampler, mui_chrono_sampler_gauss_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: nearest neighbor; temporal sampler: mean
float mui_fetch_pseudo_nearest_neighbor_mean_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                                      mui_sampler_pseudo_nearest_neighbor_3f* spatial_sampler, mui_chrono_sampler_mean_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_pseudo_nearest_neighbor_mean_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                                       mui_sampler_pseudo_nearest_neighbor_3fx* spatial_sampler, mui_chrono_sampler_mean_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_mean_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                                       mui_sampler_pseudo_nearest_neighbor_3d* spatial_sampler, mui_chrono_sampler_mean_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_mean_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                                        mui_sampler_pseudo_nearest_neighbor_3dx* spatial_sampler, mui_chrono_sampler_mean_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_mean_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                                       mui_sampler_pseudo_nearest_neighbor_3t* spatial_sampler, mui_chrono_sampler_mean_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: nearest neighbor; temporal sampler: sum
float mui_fetch_pseudo_nearest_neighbor_sum_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                                     mui_sampler_pseudo_nearest_neighbor_3f* spatial_sampler, mui_chrono_sampler_sum_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_pseudo_nearest_neighbor_sum_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                                      mui_sampler_pseudo_nearest_neighbor_3fx* spatial_sampler, mui_chrono_sampler_sum_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_sum_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                                      mui_sampler_pseudo_nearest_neighbor_3d* spatial_sampler, mui_chrono_sampler_sum_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_sum_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                                       mui_sampler_pseudo_nearest_neighbor_3dx* spatial_sampler, mui_chrono_sampler_sum_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_sum_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                                      mui_sampler_pseudo_nearest_neighbor_3t* spatial_sampler, mui_chrono_sampler_sum_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: shepard quintic; temporal sampler: exact
float mui_fetch_shepard_quintic_exact_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                               mui_sampler_shepard_quintic_3f* spatial_sampler, mui_chrono_sampler_exact_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_shepard_quintic_exact_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                                mui_sampler_shepard_quintic_3fx* spatial_sampler, mui_chrono_sampler_exact_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_exact_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                                mui_sampler_shepard_quintic_3d* spatial_sampler, mui_chrono_sampler_exact_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_exact_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                                 mui_sampler_shepard_quintic_3dx* spatial_sampler, mui_chrono_sampler_exact_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_exact_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                                mui_sampler_shepard_quintic_3t* spatial_sampler, mui_chrono_sampler_exact_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: shepard quintic; temporal sampler: gauss
float mui_fetch_shepard_quintic_gauss_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                               mui_sampler_shepard_quintic_3f* spatial_sampler, mui_chrono_sampler_gauss_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_shepard_quintic_gauss_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                                mui_sampler_shepard_quintic_3fx* spatial_sampler, mui_chrono_sampler_gauss_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_gauss_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                                mui_sampler_shepard_quintic_3d* spatial_sampler, mui_chrono_sampler_gauss_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_gauss_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                                 mui_sampler_shepard_quintic_3dx* spatial_sampler, mui_chrono_sampler_gauss_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_gauss_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                                mui_sampler_shepard_quintic_3t* spatial_sampler, mui_chrono_sampler_gauss_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: shepard quintic; temporal sampler: mean
float mui_fetch_shepard_quintic_mean_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                              mui_sampler_shepard_quintic_3f* spatial_sampler, mui_chrono_sampler_mean_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_shepard_quintic_mean_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                               mui_sampler_shepard_quintic_3fx* spatial_sampler, mui_chrono_sampler_mean_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_mean_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                               mui_sampler_shepard_quintic_3d* spatial_sampler, mui_chrono_sampler_mean_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_mean_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                                mui_sampler_shepard_quintic_3dx* spatial_sampler, mui_chrono_sampler_mean_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_mean_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                               mui_sampler_shepard_quintic_3t* spatial_sampler, mui_chrono_sampler_mean_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: shepard quintic; temporal sampler: sum
float mui_fetch_shepard_quintic_sum_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                             mui_sampler_shepard_quintic_3f* spatial_sampler, mui_chrono_sampler_sum_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_shepard_quintic_sum_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                              mui_sampler_shepard_quintic_3fx* spatial_sampler, mui_chrono_sampler_sum_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_sum_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                              mui_sampler_shepard_quintic_3d* spatial_sampler, mui_chrono_sampler_sum_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_sum_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                               mui_sampler_shepard_quintic_3dx* spatial_sampler, mui_chrono_sampler_sum_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_sum_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                              mui_sampler_shepard_quintic_3t* spatial_sampler, mui_chrono_sampler_sum_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: sph-derived quintic; temporal sampler: exact
float mui_fetch_sph_quintic_exact_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                           mui_sampler_sph_quintic_3f* spatial_sampler, mui_chrono_sampler_exact_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sph_quintic_exact_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                            mui_sampler_sph_quintic_3fx* spatial_sampler, mui_chrono_sampler_exact_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_exact_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                            mui_sampler_sph_quintic_3d* spatial_sampler, mui_chrono_sampler_exact_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_exact_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                             mui_sampler_sph_quintic_3dx* spatial_sampler, mui_chrono_sampler_exact_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_exact_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                            mui_sampler_sph_quintic_3t* spatial_sampler, mui_chrono_sampler_exact_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: sph-derived quintic; temporal sampler: gauss
float mui_fetch_sph_quintic_gauss_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                           mui_sampler_sph_quintic_3f* spatial_sampler, mui_chrono_sampler_gauss_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sph_quintic_gauss_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                            mui_sampler_sph_quintic_3fx* spatial_sampler, mui_chrono_sampler_gauss_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_gauss_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                            mui_sampler_sph_quintic_3d* spatial_sampler, mui_chrono_sampler_gauss_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_gauss_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                             mui_sampler_sph_quintic_3dx* spatial_sampler, mui_chrono_sampler_gauss_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_gauss_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                            mui_sampler_sph_quintic_3t* spatial_sampler, mui_chrono_sampler_gauss_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: sph-derived quintic; temporal sampler: mean
float mui_fetch_sph_quintic_mean_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                          mui_sampler_sph_quintic_3f* spatial_sampler, mui_chrono_sampler_mean_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sph_quintic_mean_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                           mui_sampler_sph_quintic_3fx* spatial_sampler, mui_chrono_sampler_mean_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_mean_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                           mui_sampler_sph_quintic_3d* spatial_sampler, mui_chrono_sampler_mean_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_mean_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                            mui_sampler_sph_quintic_3dx* spatial_sampler, mui_chrono_sampler_mean_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_mean_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                           mui_sampler_sph_quintic_3t* spatial_sampler, mui_chrono_sampler_mean_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: sph-derived quintic; temporal sampler: sum
float mui_fetch_sph_quintic_sum_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                         mui_sampler_sph_quintic_3f* spatial_sampler, mui_chrono_sampler_sum_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sph_quintic_sum_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                          mui_sampler_sph_quintic_3fx* spatial_sampler, mui_chrono_sampler_sum_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_sum_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                          mui_sampler_sph_quintic_3d* spatial_sampler, mui_chrono_sampler_sum_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_sum_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                           mui_sampler_sph_quintic_3dx* spatial_sampler, mui_chrono_sampler_sum_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_sum_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                          mui_sampler_sph_quintic_3t* spatial_sampler, mui_chrono_sampler_sum_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: summation quintic; temporal sampler: exact
float mui_fetch_sum_quintic_exact_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                           mui_sampler_sum_quintic_3f* spatial_sampler, mui_chrono_sampler_exact_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sum_quintic_exact_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                            mui_sampler_sum_quintic_3fx* spatial_sampler, mui_chrono_sampler_exact_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_exact_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                            mui_sampler_sum_quintic_3d* spatial_sampler, mui_chrono_sampler_exact_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_exact_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                             mui_sampler_sum_quintic_3dx* spatial_sampler, mui_chrono_sampler_exact_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_exact_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                            mui_sampler_sum_quintic_3t* spatial_sampler, mui_chrono_sampler_exact_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: summation quintic; temporal sampler: gauss
float mui_fetch_sum_quintic_gauss_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                           mui_sampler_sum_quintic_3f* spatial_sampler, mui_chrono_sampler_gauss_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sum_quintic_gauss_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                            mui_sampler_sum_quintic_3fx* spatial_sampler, mui_chrono_sampler_gauss_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_gauss_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                            mui_sampler_sum_quintic_3d* spatial_sampler, mui_chrono_sampler_gauss_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_gauss_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                             mui_sampler_sum_quintic_3dx* spatial_sampler, mui_chrono_sampler_gauss_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_gauss_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                            mui_sampler_sum_quintic_3t* spatial_sampler, mui_chrono_sampler_gauss_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: summation quintic; temporal sampler: mean
float mui_fetch_sum_quintic_mean_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                          mui_sampler_sum_quintic_3f* spatial_sampler, mui_chrono_sampler_mean_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sum_quintic_mean_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                           mui_sampler_sum_quintic_3fx* spatial_sampler, mui_chrono_sampler_mean_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_mean_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                           mui_sampler_sum_quintic_3d* spatial_sampler, mui_chrono_sampler_mean_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_mean_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                            mui_sampler_sum_quintic_3dx* spatial_sampler, mui_chrono_sampler_mean_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_mean_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                           mui_sampler_sum_quintic_3t* spatial_sampler, mui_chrono_sampler_mean_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
// Spatial sampler: summation quintic; temporal sampler: sum
float mui_fetch_sum_quintic_sum_3f_pair( mui_uniface_3f* uniface, const char *attr, mui_point_3f point, float t_1, float t_2,
                                         mui_sampler_sum_quintic_3f* spatial_sampler, mui_chrono_sampler_sum_3f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3f(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sum_quintic_sum_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                          mui_sampler_sum_quintic_3fx* spatial_sampler, mui_chrono_sampler_sum_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_sum_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                          mui_sampler_sum_quintic_3d* spatial_sampler, mui_chrono_sampler_sum_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_sum_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                           mui_sampler_sum_quintic_3dx* spatial_sampler, mui_chrono_sampler_sum_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_sum_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                          mui_sampler_sum_quintic_3t* spatial_sampler, mui_chrono_sampler_sum_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
float mui_fetch_rbf_exact_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                    mui_sampler_rbf_3fx* spatial_sampler, mui_chrono_sampler_exact_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_rbf_exact_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                    mui_sampler_rbf_3d* spatial_sampler, mui_chrono_sampler_exact_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_rbf_exact_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                     mui_sampler_rbf_3dx* spatial_sampler, mui_chrono_sampler_exact_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_rbf_exact_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                    mui_sampler_rbf_3t* spatial_sampler, mui_chrono_sampler_exact_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
float mui_fetch_rbf_gauss_3fx_pair( mui_uniface_3fx* uniface, const char *attr, mui_point_3fx point, float t_1, float t_2,
                                    mui_sampler_rbf_3fx* spatial_sampler, mui_chrono_sampler_gauss_3fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3fx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_rbf_gauss_3d_pair( mui_uniface_3d* uniface, const char *attr, mui_point_3d point, double t_1, double t_2,
                                    mui_sampler_rbf_3d* spatial_sampler, mui_chrono_sampler_gauss_3d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3d(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_rbf_gauss_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                     mui_sampler_rbf_3dx* spatial_sampler, mui_chrono_sampler_gauss_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_rbf_gauss_3t_pair( mui_uniface_3t* uniface, const char *attr, mui_point_3t point, double t_1, double t_2,
                                    mui_sampler_rbf_3t* spatial_sampler, mui_chrono_sampler_gauss_3t* temporal_sampler ) {
  mui::mui_c_wrapper_3D::point_type point_fetch( static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_2),
                                                 static_cast<mui::mui_c_wrapper_3D::REAL>(point.point_3) );
...
double mui_fetch_rbf_mean_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                    mui_sampler_rbf_3dx* spatial_sampler, mui_chrono_sampler_mean_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}
...
double mui_fetch_rbf_sum_3dx_pair( mui_uniface_3dx* uniface, const char *attr, mui_point_3dx point, double t_1, double t_2,
                                   mui_sampler_rbf_3dx* spatial_sampler, mui_chrono_sampler_sum_3dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point3dx(point.point_1, point.point_2, point.point_3), t_1, t_2, *spatial_sampler, *temporal_sampler );
}
...
void mui_fetch_points_exact_3f( mui_uniface_3f* uniface, const char *attr, float t, mui_chrono_sampler_exact_3f* temporal_sampler, mui_point_3f* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_3fx( mui_uniface_3fx* uniface, const char *attr, float t, mui_chrono_sampler_exact_3fx* temporal_sampler, mui_point_3fx* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_3d( mui_uniface_3d* uniface, const char *attr, double t, mui_chrono_sampler_exact_3d* temporal_sampler, mui_point_3d* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_3dx( mui_uniface_3dx* uniface, const char *attr, double t, mui_chrono_sampler_exact_3dx* temporal_sampler, mui_point_3dx* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_3t( mui_uniface_3t* uniface, const char *attr, double t, mui_chrono_sampler_exact_3t* temporal_sampler, mui_point_3t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_3D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
...
void mui_fetch_points_gauss_3f( mui_uniface_3f* uniface, const char *attr, float t, mui_chrono_sampler_gauss_3f* temporal_sampler, mui_point_3f* ret_points, int* num_points ) {
  std::vector<mui::point3f> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_3f*)malloc( ret_pts.size() * sizeof(mui_point_3f) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_3fx( mui_uniface_3fx* uniface, const char *attr, float t, mui_chrono_sampler_gauss_3fx* temporal_sampler, mui_point_3fx* ret_points, int* num_points ) {
  std::vector<mui::point3fx> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_3fx*)malloc( ret_pts.size() * sizeof(mui_point_3fx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_3d( mui_uniface_3d* uniface, const char *attr, double t, mui_chrono_sampler_gauss_3d* temporal_sampler, mui_point_3d* ret_points, int* num_points ) {
  std::vector<mui::point3d> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_3d*)malloc( ret_pts.size() * sizeof(mui_point_3d) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_3dx( mui_uniface_3dx* uniface, const char *attr, double t, mui_chrono_sampler_gauss_3dx* temporal_sampler, mui_point_3dx* ret_points, int* num_points ) {
  std::vector<mui::point3dx> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_3dx*)malloc( ret_pts.size() * sizeof(mui_point_3dx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_3t( mui_uniface_3t* uniface, const char *attr, double t, mui_chrono_sampler_gauss_3t* temporal_sampler, mui_point_3t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_3D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_3t*)malloc( ret_pts.size() * sizeof(mui_point_3t) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = static_cast<double>(ret_pts[i][0]);
...
void mui_fetch_points_mean_3f( mui_uniface_3f* uniface, const char *attr, float t, mui_chrono_sampler_mean_3f* temporal_sampler, mui_point_3f* ret_points, int* num_points ) {
  std::vector<mui::point3f> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_3f*)malloc( ret_pts.size() * sizeof(mui_point_3f) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_3fx( mui_uniface_3fx* uniface, const char *attr, float t, mui_chrono_sampler_mean_3fx* temporal_sampler, mui_point_3fx* ret_points, int* num_points ) {
  std::vector<mui::point3fx> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_3fx*)malloc( ret_pts.size() * sizeof(mui_point_3fx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_3d( mui_uniface_3d* uniface, const char *attr, double t, mui_chrono_sampler_mean_3d* temporal_sampler, mui_point_3d* ret_points, int* num_points ) {
  std::vector<mui::point3d> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_3d*)malloc( ret_pts.size() * sizeof(mui_point_3d) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_3dx( mui_uniface_3dx* uniface, const char *attr, double t, mui_chrono_sampler_mean_3dx* temporal_sampler, mui_point_3dx* ret_points, int* num_points ) {
  std::vector<mui::point3dx> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_3dx*)malloc( ret_pts.size() * sizeof(mui_point_3dx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_3t( mui_uniface_3t* uniface, const char *attr, double t, mui_chrono_sampler_mean_3t* temporal_sampler, mui_point_3t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_3D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_3t*)malloc( ret_pts.size() * sizeof(mui_point_3t) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = static_cast<double>(ret_pts[i][0]);
...
void mui_fetch_points_sum_3f( mui_uniface_3f* uniface, const char *attr, float t, mui_chrono_sampler_sum_3f* temporal_sampler, mui_point_3f* ret_points, int* num_points ) {
  std::vector<mui::point3f> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_3f*)malloc( ret_pts.size() * sizeof(mui_point_3f) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_3fx( mui_uniface_3fx* uniface, const char *attr, float t, mui_chrono_sampler_sum_3fx* temporal_sampler, mui_point_3fx* ret_points, int* num_points ) {
  std::vector<mui::point3fx> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_3fx*)malloc( ret_pts.size() * sizeof(mui_point_3fx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_3d( mui_uniface_3d* uniface, const char *attr, double t, mui_chrono_sampler_sum_3d* temporal_sampler, mui_point_3d* ret_points, int* num_points ) {
  std::vector<mui::point3d> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_3d*)malloc( ret_pts.size() * sizeof(mui_point_3d) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_3dx( mui_uniface_3dx* uniface, const char *attr, double t, mui_chrono_sampler_sum_3dx* temporal_sampler, mui_point_3dx* ret_points, int* num_points ) {
  std::vector<mui::point3dx> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_3dx*)malloc( ret_pts.size() * sizeof(mui_point_3dx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_3t( mui_uniface_3t* uniface, const char *attr, double t, mui_chrono_sampler_sum_3t* temporal_sampler, mui_point_3t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_3D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_3t*)malloc( ret_pts.size() * sizeof(mui_point_3t) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = static_cast<double>(ret_pts[i][0]);
...
// Temporal sampler: exact
void mui_fetch_points_exact_3f_pair( mui_uniface_3f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_exact_3f* temporal_sampler, mui_point_3f* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_3fx_pair( mui_uniface_3fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_exact_3fx* temporal_sampler, mui_point_3fx* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_3d_pair( mui_uniface_3d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_exact_3d* temporal_sampler, mui_point_3d* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_3dx_pair( mui_uniface_3dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_exact_3dx* temporal_sampler, mui_point_3dx* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_3t_pair( mui_uniface_3t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_exact_3t* temporal_sampler, mui_point_3t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_3D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3t*)malloc( ret_pts.size() * sizeof(mui_point_3t) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = static_cast<double>(ret_pts[i][0]);
    ret_points[i].point_2 = static_cast<double>(ret_pts[i][1]);
...
// Temporal sampler: gauss
void mui_fetch_points_gauss_3f_pair( mui_uniface_3f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_gauss_3f* temporal_sampler, mui_point_3f* ret_points, int* num_points ) {
  std::vector<mui::point3f> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3f*)malloc( ret_pts.size() * sizeof(mui_point_3f) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_3fx_pair( mui_uniface_3fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_gauss_3fx* temporal_sampler, mui_point_3fx* ret_points, int* num_points ) {
  std::vector<mui::point3fx> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3fx*)malloc( ret_pts.size() * sizeof(mui_point_3fx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_3d_pair( mui_uniface_3d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_gauss_3d* temporal_sampler, mui_point_3d* ret_points, int* num_points ) {
  std::vector<mui::point3d> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3d*)malloc( ret_pts.size() * sizeof(mui_point_3d) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_3dx_pair( mui_uniface_3dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_gauss_3dx* temporal_sampler, mui_point_3dx* ret_points, int* num_points ) {
  std::vector<mui::point3dx> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3dx*)malloc( ret_pts.size() * sizeof(mui_point_3dx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_3t_pair( mui_uniface_3t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_gauss_3t* temporal_sampler, mui_point_3t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_3D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3t*)malloc( ret_pts.size() * sizeof(mui_point_3t) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = static_cast<double>(ret_pts[i][0]);
...
// Temporal sampler: mean
void mui_fetch_points_mean_3f_pair( mui_uniface_3f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_mean_3f* temporal_sampler, mui_point_3f* ret_points, int* num_points ) {
  std::vector<mui::point3f> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3f*)malloc( ret_pts.size() * sizeof(mui_point_3f) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_3fx_pair( mui_uniface_3fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_mean_3fx* temporal_sampler, mui_point_3fx* ret_points, int* num_points ) {
  std::vector<mui::point3fx> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3fx*)malloc( ret_pts.size() * sizeof(mui_point_3fx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_3d_pair( mui_uniface_3d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_mean_3d* temporal_sampler, mui_point_3d* ret_points, int* num_points ) {
  std::vector<mui::point3d> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3d*)malloc( ret_pts.size() * sizeof(mui_point_3d) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_3dx_pair( mui_uniface_3dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_mean_3dx* temporal_sampler, mui_point_3dx* ret_points, int* num_points ) {
  std::vector<mui::point3dx> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3dx*)malloc( ret_pts.size() * sizeof(mui_point_3dx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_3t_pair( mui_uniface_3t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_mean_3t* temporal_sampler, mui_point_3t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_3D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3t*)malloc( ret_pts.size() * sizeof(mui_point_3t) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = static_cast<double>(ret_pts[i][0]);
...
// Temporal sampler: sum
void mui_fetch_points_sum_3f_pair( mui_uniface_3f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_sum_3f* temporal_sampler, mui_point_3f* ret_points, int* num_points ) {
  std::vector<mui::point3f> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3f*)malloc( ret_pts.size() * sizeof(mui_point_3f) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_3fx_pair( mui_uniface_3fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_sum_3fx* temporal_sampler, mui_point_3fx* ret_points, int* num_points ) {
  std::vector<mui::point3fx> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3fx*)malloc( ret_pts.size() * sizeof(mui_point_3fx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_3d_pair( mui_uniface_3d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_sum_3d* temporal_sampler, mui_point_3d* ret_points, int* num_points ) {
  std::vector<mui::point3d> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3d*)malloc( ret_pts.size() * sizeof(mui_point_3d) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_3dx_pair( mui_uniface_3dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_sum_3dx* temporal_sampler, mui_point_3dx* ret_points, int* num_points ) {
  std::vector<mui::point3dx> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3dx*)malloc( ret_pts.size() * sizeof(mui_point_3dx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_3t_pair( mui_uniface_3t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_sum_3t* temporal_sampler, mui_point_3t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_3D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_3t*)malloc( ret_pts.size() * sizeof(mui_point_3t) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = static_cast<double>(ret_pts[i][0]);
...
// Temporal sampler: exact
void mui_fetch_values_exact_3f( mui_uniface_3f* uniface, const char *attr, float t, mui_chrono_sampler_exact_3f* temporal_sampler, float* values, int* num_values ) {
...
void mui_fetch_values_exact_3fx( mui_uniface_3fx* uniface, const char *attr, float t, mui_chrono_sampler_exact_3fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_exact_3d( mui_uniface_3d* uniface, const char *attr, double t, mui_chrono_sampler_exact_3d* temporal_sampler, double* values, int* num_values ) {
...
void mui_fetch_values_exact_3dx( mui_uniface_3dx* uniface, const char *attr, double t, mui_chrono_sampler_exact_3dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_exact_3t( mui_uniface_3t* uniface, const char *attr, double t, mui_chrono_sampler_exact_3t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_3D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_3D::REAL>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
...
// Temporal sampler: gauss
void mui_fetch_values_gauss_3f( mui_uniface_3f* uniface, const char *attr, float t, mui_chrono_sampler_gauss_3f* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_3fx( mui_uniface_3fx* uniface, const char *attr, float t, mui_chrono_sampler_gauss_3fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_3d( mui_uniface_3d* uniface, const char *attr, double t, mui_chrono_sampler_gauss_3d* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_3dx( mui_uniface_3dx* uniface, const char *attr, double t, mui_chrono_sampler_gauss_3dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_3t( mui_uniface_3t* uniface, const char *attr, double t, mui_chrono_sampler_gauss_3t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_3D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_3D::REAL>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = static_cast<double>(ret_vals[i]);
...
// Temporal sampler: mean
void mui_fetch_values_mean_3f( mui_uniface_3f* uniface, const char *attr, float t, mui_chrono_sampler_mean_3f* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_3fx( mui_uniface_3fx* uniface, const char *attr, float t, mui_chrono_sampler_mean_3fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_3d( mui_uniface_3d* uniface, const char *attr, double t, mui_chrono_sampler_mean_3d* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_3dx( mui_uniface_3dx* uniface, const char *attr, double t, mui_chrono_sampler_mean_3dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_3t( mui_uniface_3t* uniface, const char *attr, double t, mui_chrono_sampler_mean_3t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_3D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_3D::REAL>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = static_cast<double>(ret_vals[i]);
...
// Temporal sampler: sum
void mui_fetch_values_sum_3f( mui_uniface_3f* uniface, const char *attr, float t, mui_chrono_sampler_sum_3f* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_3fx( mui_uniface_3fx* uniface, const char *attr, float t, mui_chrono_sampler_sum_3fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_3d( mui_uniface_3d* uniface, const char *attr, double t, mui_chrono_sampler_sum_3d* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_3dx( mui_uniface_3dx* uniface, const char *attr, double t, mui_chrono_sampler_sum_3dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_3t( mui_uniface_3t* uniface, const char *attr, double t, mui_chrono_sampler_sum_3t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_3D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_3D::REAL>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = static_cast<double>(ret_vals[i]);
...
// Temporal sampler: exact
void mui_fetch_values_exact_3f_pair( mui_uniface_3f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_exact_3f* temporal_sampler, float* values, int* num_values ) {
...
void mui_fetch_values_exact_3fx_pair( mui_uniface_3fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_exact_3fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_exact_3d_pair( mui_uniface_3d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_exact_3d* temporal_sampler, double* values, int* num_values ) {
...
void mui_fetch_values_exact_3dx_pair( mui_uniface_3dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_exact_3dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_exact_3t_pair( mui_uniface_3t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_exact_3t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_3D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_3D::REAL>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = static_cast<double>(ret_vals[i]);
  }
...
// Temporal sampler: gauss
void mui_fetch_values_gauss_3f_pair( mui_uniface_3f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_gauss_3f* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_3fx_pair( mui_uniface_3fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_gauss_3fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_3d_pair( mui_uniface_3d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_gauss_3d* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_3dx_pair( mui_uniface_3dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_gauss_3dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_3t_pair( mui_uniface_3t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_gauss_3t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_3D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_3D::REAL>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = static_cast<double>(ret_vals[i]);
...
// Temporal sampler: mean
void mui_fetch_values_mean_3f_pair( mui_uniface_3f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_mean_3f* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_3fx_pair( mui_uniface_3fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_mean_3fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_3d_pair( mui_uniface_3d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_mean_3d* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_3dx_pair( mui_uniface_3dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_mean_3dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_3t_pair( mui_uniface_3t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_mean_3t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_3D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_3D::REAL>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = static_cast<double>(ret_vals[i]);
...
// Temporal sampler: sum
void mui_fetch_values_sum_3f_pair( mui_uniface_3f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_sum_3f* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_3fx_pair( mui_uniface_3fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_sum_3fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_3d_pair( mui_uniface_3d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_sum_3d* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_3dx_pair( mui_uniface_3dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_sum_3dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_3t_pair( mui_uniface_3t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_sum_3t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_3D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_3D::REAL>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = static_cast<double>(ret_vals[i]);
...
int mui_is_ready_3t_pair( mui_uniface_3t* uniface, const char *attr, double t_1, double t_2 ) {
  return uniface->is_ready( std::string(attr), static_cast<mui::mui_c_wrapper_3D::time_type>(t_1), static_cast<mui::mui_c_wrapper_3D::time_type>(t_2) );
}
...
void mui_announce_send_span_3f_box( mui_uniface_3f* uniface, float box_1_1, float box_1_2, float box_1_3,
...
void mui_announce_send_span_3t_box( mui_uniface_3t* uniface, double box_1_1, double box_1_2, double box_1_3,
                                    double box_2_1, double box_2_2, double box_2_3, double t_start, double t_timeout ) {
  mui::geometry::box<mui::mui_c_wrapper_3D> bound_box( {static_cast<mui::mui_c_wrapper_3D::REAL>(box_1_1), static_cast<mui::mui_c_wrapper_3D::REAL>(box_1_2), static_cast<mui::mui_c_wrapper_3D::REAL>(box_1_3)},
                                                       {static_cast<mui::mui_c_wrapper_3D::REAL>(box_2_1), static_cast<mui::mui_c_wrapper_3D::REAL>(box_2_2), static_cast<mui::mui_c_wrapper_3D::REAL>(box_2_3)} );
  uniface->announce_send_span(static_cast<mui::mui_c_wrapper_3D::time_type>(t_start), static_cast<mui::mui_c_wrapper_3D::time_type>(t_timeout), bound_box);
}

// Send span announce using 3D sphere geometry
void mui_announce_send_span_3f_sphere( mui_uniface_3f* uniface, mui_point_3f centre, float radius, float t_start, float t_timeout ) {
...
void mui_announce_send_span_3fx_sphere( mui_uniface_3fx* uniface, mui_point_3fx centre, float radius, float t_start, float t_timeout ) {
  mui::geometry::sphere3fx bound_sphere( mui::point3fx(centre.point_1, centre.point_2, centre.point_3), radius );
  uniface->announce_send_span(t_start, t_timeout, bound_sphere);
}

void mui_announce_send_span_3d_sphere( mui_uniface_3d* uniface, mui_point_3d centre, double radius, double t_start, double t_timeout ) {
  mui::geometry::sphere3d bound_sphere( mui::point3d(centre.point_1, centre.point_2, centre.point_3), radius );
  uniface->announce_send_span(t_start, t_timeout, bound_sphere);
}

void mui_announce_send_span_3dx_sphere( mui_uniface_3dx* uniface, mui_point_3dx centre, double radius, double t_start, double t_timeout ) {
  mui::geometry::sphere3dx bound_sphere( mui::point3dx(centre.point_1, centre.point_2, centre.point_3), radius );
  uniface->announce_send_span(t_start, t_timeout, bound_sphere);
}

void mui_announce_send_span_3t_sphere( mui_uniface_3t* uniface, mui_point_3t centre, double radius, double t_start, double t_timeout ) {
  mui::geometry::sphere<mui::mui_c_wrapper_3D> bound_sphere( mui::mui_c_wrapper_3D::point_type(static_cast<mui::mui_c_wrapper_3D::REAL>(centre.point_1),
  ...
  uniface->announce_send_span(static_cast<mui::mui_c_wrapper_3D::time_type>(t_start), static_cast<mui::mui_c_wrapper_3D::time_type>(t_timeout), bound_sphere);
}

// Receive span announce using 3D box geometry
void mui_announce_recv_span_3f_box( mui_uniface_3f* uniface, float box_1_1, float box_1_2, float box_1_3,
                                    float box_2_1, float box_2_2, float box_2_3, float t_start, float t_timeout ) {
  mui::geometry::box3f bound_box( {box_1_1, box_1_2, box_1_3}, {box_2_1, box_2_2, box_2_3} );
...
void mui_announce_recv_span_3t_box( mui_uniface_3t* uniface, double box_1_1, double box_1_2, double box_1_3,
  ...
  mui::geometry::box<mui::mui_c_wrapper_3D> bound_box( {static_cast<mui::mui_c_wrapper_3D::REAL>(box_1_1), static_cast<mui::mui_c_wrapper_3D::REAL>(box_1_2), static_cast<mui::mui_c_wrapper_3D::REAL>(box_1_3)},
                                                       {static_cast<mui::mui_c_wrapper_3D::REAL>(box_2_1), static_cast<mui::mui_c_wrapper_3D::REAL>(box_2_2), static_cast<mui::mui_c_wrapper_3D::REAL>(box_2_3)} );
  uniface->announce_recv_span(static_cast<mui::mui_c_wrapper_3D::time_type>(t_start), static_cast<mui::mui_c_wrapper_3D::time_type>(t_timeout), bound_box);
}

// Receive span announce using 1D sphere geometry
void mui_announce_recv_span_3f_sphere( mui_uniface_3f* uniface, mui_point_3f centre, float radius, float t_start, float t_timeout ) {
  mui::geometry::sphere3f bound_sphere( mui::point3f(centre.point_1, centre.point_2, centre.point_3), radius );
  uniface->announce_recv_span(t_start, t_timeout, bound_sphere);
}

void mui_announce_recv_span_3fx_sphere( mui_uniface_3fx* uniface, mui_point_3fx centre, float radius, float t_start, float t_timeout ) {
  mui::geometry::sphere3fx bound_sphere( mui::point3fx(centre.point_1, centre.point_2, centre.point_3), radius );
  uniface->announce_recv_span(t_start, t_timeout, bound_sphere);
}

void mui_announce_recv_span_3d_sphere( mui_uniface_3d* uniface, mui_point_3d centre, double radius, double t_start, double t_timeout ) {
  mui::geometry::sphere3d bound_sphere( mui::point3d(centre.point_1, centre.point_2, centre.point_3), radius );
  uniface->announce_recv_span(t_start, t_timeout, bound_sphere);
}

void mui_announce_recv_span_3dx_sphere( mui_uniface_3dx* uniface, mui_point_3dx centre, double radius, double t_start, double t_timeout ) {
  mui::geometry::sphere3dx bound_sphere( mui::point3dx(centre.point_1, centre.point_2, centre.point_3), radius );
  uniface->announce_recv_span(t_start, t_timeout, bound_sphere);
}

void mui_announce_recv_span_3t_sphere( mui_uniface_3t* uniface, mui_point_3t centre, double radius, double t_start, double t_timeout ) {
  mui::geometry::sphere<mui::mui_c_wrapper_3D> bound_sphere( mui::mui_c_wrapper_3D::point_type(static_cast<mui::mui_c_wrapper_3D::REAL>(centre.point_1),
                                                                                               static_cast<mui::mui_c_wrapper_3D::REAL>(centre.point_2),
                                                                                               static_cast<mui::mui_c_wrapper_3D::REAL>(centre.point_3)),
                                                             static_cast<mui::mui_c_wrapper_3D::REAL>(radius) );
  uniface->announce_recv_span(static_cast<mui::mui_c_wrapper_3D::time_type>(t_start), static_cast<mui::mui_c_wrapper_3D::time_type>(t_timeout), bound_sphere);
}
...
void mui_barrier_3t_pair( mui_uniface_3t* uniface, double t_1, double t_2 ) {
  uniface->barrier(static_cast<mui::mui_c_wrapper_3D::time_type>(t_1), static_cast<mui::mui_c_wrapper_3D::time_type>(t_2));
}
...
void mui_forget_lower_upper_3f_pair( mui_uniface_3f* uniface, float lower_1, float lower_2, float upper_1, float upper_2, int reset_log ) {
  std::pair<float, float> forget_time_1(lower_1, lower_2);
  std::pair<float, float> forget_time_2(upper_1, upper_2);
  uniface->forget(forget_time_1, forget_time_2, static_cast<bool>(reset_log));
}

void mui_forget_lower_upper_3fx_pair( mui_uniface_3fx* uniface, float lower_1, float lower_2, float upper_1, float upper_2, int reset_log ) {
  std::pair<float, float> forget_time_1(lower_1, lower_2);
  std::pair<float, float> forget_time_2(upper_1, upper_2);
  uniface->forget(forget_time_1, forget_time_2, static_cast<bool>(reset_log));
}

void mui_forget_lower_upper_3d_pair( mui_uniface_3d* uniface, double lower_1, double lower_2, double upper_1, double upper_2, int reset_log ) {
  std::pair<double, double> forget_time_1(lower_1, lower_2);
  std::pair<double, double> forget_time_2(upper_1, upper_2);
  uniface->forget(forget_time_1, forget_time_2, static_cast<bool>(reset_log));
}

void mui_forget_lower_upper_3dx_pair( mui_uniface_3dx* uniface, double lower_1, double lower_2, double upper_1, double upper_2, int reset_log ) {
  std::pair<double, double> forget_time_1(lower_1, lower_2);
  std::pair<double, double> forget_time_2(upper_1, upper_2);
  uniface->forget(forget_time_1, forget_time_2, static_cast<bool>(reset_log));
}

void mui_forget_lower_upper_3t_pair( mui_uniface_3t* uniface, double lower_1, double lower_2, double upper_1, double upper_2, int reset_log ) {
