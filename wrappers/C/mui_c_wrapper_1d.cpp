...
mui_sampler_rbf_1f* mui_create_sampler_rbf_1f(float r, mui_point_1f *points, int points_count, int basis_func,
	...
	return new mui_sampler_rbf_1f(r, pts, basis_func, static_cast<bool>(conservative),
...
mui_sampler_rbf_1fx* mui_create_sampler_rbf_1fx(float r, mui_point_1f *points, int points_count, int basis_func,
		int conservative, int smoothFunc, int readMatrix, int writeMatrix, const char *file_address,
		float cutoff, float cg_solve_tol, int cg_solve_it, int pou_size, int precond, MPI_Comm local_comm) {
	...
	return new mui_sampler_rbf_1fx(r, pts, basis_func, static_cast<bool>(conservative),
			static_cast<bool>(smoothFunc), static_cast<bool>(readMatrix), static_cast<bool>(writeMatrix), std::string(file_address),
			cutoff, cg_solve_tol, cg_solve_it, pou_size, precond, local_comm);
}
...
mui_sampler_rbf_1d* mui_create_sampler_rbf_1d(double r, mui_point_1d *points, int points_count, int basis_func,
	...
	return new mui_sampler_rbf_1d(r, pts, basis_func, static_cast<bool>(conservative),
			static_cast<bool>(smoothFunc), static_cast<bool>(readMatrix), static_cast<bool>(writeMatrix), std::string(file_address),
			cutoff, cg_solve_tol, cg_solve_it, pou_size, precond, local_comm);
}
...
mui_sampler_rbf_1dx* mui_create_sampler_rbf_1dx(double r, mui_point_1dx *points, int points_count, int basis_func,
	...
	return new mui_sampler_rbf_1dx(r, pts, basis_func, static_cast<bool>(conservative),
			static_cast<bool>(smoothFunc), static_cast<bool>(readMatrix), static_cast<bool>(writeMatrix), std::string(file_address),
			cutoff, cg_solve_tol, cg_solve_it, pou_size, precond, local_comm);
}
