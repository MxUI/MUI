...
mui_sampler_gauss_2t* mui_create_sampler_gauss_2t( double r, double h ) {
  return new mui_sampler_gauss_2t( static_cast<mui::mui_c_wrapper_2D::REAL>(r), static_cast<mui::mui_c_wrapper_2D::REAL>(h) );
}
...
mui_sampler_rbf_2f* mui_create_sampler_rbf_2f( float r, mui_point_2f* points, int points_count,
  ...
  return new mui_sampler_rbf_2f( r, pts, basis_func, static_cast<bool>(conservative), static_cast<bool>(polynomial), static_cast<bool>(smoothFunc),
                                 static_cast<bool>(readMatrix), std::string(file_address), cutoff );
}

mui_sampler_rbf_2fx* mui_create_sampler_rbf_2fx( float r, mui_point_2fx* points, int points_count,
                                                 int basis_func, int conservative, int polynomial, int smoothFunc, int readMatrix,
                                                 const char* file_address, float cutoff ) {
  ...
  return new mui_sampler_rbf_2fx( r, pts, basis_func, static_cast<bool>(conservative), static_cast<bool>(polynomial), static_cast<bool>(smoothFunc),
                                  static_cast<bool>(readMatrix), std::string(file_address), cutoff );
}

mui_sampler_rbf_2d* mui_create_sampler_rbf_2d( double r, mui_point_2d* points, int points_count,
                                               int basis_func, int conservative, int polynomial, int smoothFunc, int readMatrix,
  ...
  return new mui_sampler_rbf_2d( r, pts, basis_func, static_cast<bool>(conservative), static_cast<bool>(polynomial), static_cast<bool>(smoothFunc),
                                 static_cast<bool>(readMatrix), std::string(file_address), cutoff );
}

mui_sampler_rbf_2dx* mui_create_sampler_rbf_2dx( double r, mui_point_2dx* points, int points_count,
                                                 int basis_func, int conservative, int polynomial, int smoothFunc, int readMatrix,
                                                 const char* file_address, double cutoff ) {
  ...
  return new mui_sampler_rbf_2dx( r, pts, basis_func, static_cast<bool>(conservative), static_cast<bool>(polynomial), static_cast<bool>(smoothFunc),
                                  static_cast<bool>(readMatrix), std::string(file_address), cutoff );
}

mui_sampler_rbf_2t* mui_create_sampler_rbf_2t( double r, mui_point_2t* points, int points_count, int basis_func, int conservative,
  ...
  return new mui_sampler_rbf_2t( static_cast<mui::mui_c_wrapper_2D::REAL>(r), pts, basis_func, static_cast<bool>(conservative), static_cast<bool>(polynomial),
                                 static_cast<bool>(smoothFunc), static_cast<bool>(readMatrix), std::string(file_address), static_cast<mui::mui_c_wrapper_2D::REAL>(cutoff) );
}
#endif
...
mui_chrono_sampler_gauss_2t* mui_create_chrono_sampler_gauss_2t( double cutoff, double sigma ) {
  return new mui_chrono_sampler_gauss_2t( static_cast<mui::mui_c_wrapper_2D::time_type>(cutoff), static_cast<mui::mui_c_wrapper_2D::REAL>(sigma) );
}
...
mui_chrono_sampler_mean_2t* mui_create_chrono_sampler_mean_2t( double lower, double upper ) {
  return new mui_chrono_sampler_mean_2t( static_cast<mui::mui_c_wrapper_2D::time_type>(lower), static_cast<mui::mui_c_wrapper_2D::time_type>(upper) );
}
...
mui_chrono_sampler_sum_2t* mui_create_chrono_sampler_sum_2t( double lower, double upper ) {
  return new mui_chrono_sampler_sum_2t( static_cast<mui::mui_c_wrapper_2D::time_type>(lower), static_cast<mui::mui_c_wrapper_2D::time_type>(upper) );
}
...
void mui_commit_2t_pair( mui_uniface_2t* uniface, double t_1, double t_2 ) {
  uniface->commit( static_cast<mui::mui_c_wrapper_2D::time_type>(t_1), static_cast<mui::mui_c_wrapper_2D::time_type>(t_2) );
}
...
void mui_forecast_2t_pair( mui_uniface_2t* uniface, double t_1, double t_2 ) {
  uniface->forecast( static_cast<mui::mui_c_wrapper_2D::time_type>(t_1), static_cast<mui::mui_c_wrapper_2D::time_type>(t_2) );
}
...
float mui_fetch_exact_exact_2f( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t,
  ...
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t, *spatial_sampler, *temporal_sampler );
}
...
float mui_fetch_exact_exact_2fx( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t,
  ...
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t, *spatial_sampler, *temporal_sampler );
}
...
double mui_fetch_exact_exact_2d( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t,
  ...
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t, *spatial_sampler, *temporal_sampler );
}
...
double mui_fetch_exact_exact_2dx( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t,
  ...
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t, *spatial_sampler, *temporal_sampler );
}
...
double mui_fetch_exact_exact_2t( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t,
  ...
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t),
...
float mui_fetch_pseudo_nearest_neighbor_exact_2fx( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t,
                                                   mui_sampler_pseudo_nearest_neighbor_2fx* spatial_sampler, mui_chrono_sampler_exact_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_exact_2d( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t,
                                                   mui_sampler_pseudo_nearest_neighbor_2d* spatial_sampler, mui_chrono_sampler_exact_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_exact_2dx( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t,
                                                    mui_sampler_pseudo_nearest_neighbor_2dx* spatial_sampler, mui_chrono_sampler_exact_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_exact_2t( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t,
                                                   mui_sampler_pseudo_nearest_neighbor_2t* spatial_sampler, mui_chrono_sampler_exact_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t),
                                      *spatial_sampler, *temporal_sampler ));
...
float mui_fetch_pseudo_nearest_neighbor_gauss_2fx( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t,
                                                   mui_sampler_pseudo_nearest_neighbor_2fx* spatial_sampler, mui_chrono_sampler_gauss_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_gauss_2d( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t,
                                                   mui_sampler_pseudo_nearest_neighbor_2d* spatial_sampler, mui_chrono_sampler_gauss_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_gauss_2dx( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t,
                                                    mui_sampler_pseudo_nearest_neighbor_2dx* spatial_sampler, mui_chrono_sampler_gauss_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_gauss_2t( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t,
                                                   mui_sampler_pseudo_nearest_neighbor_2t* spatial_sampler, mui_chrono_sampler_gauss_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t),
                                      *spatial_sampler, *temporal_sampler ));
...
float mui_fetch_pseudo_nearest_neighbor_mean_2fx( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t,
                                                  mui_sampler_pseudo_nearest_neighbor_2fx* spatial_sampler, mui_chrono_sampler_mean_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_mean_2d( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t,
                                                  mui_sampler_pseudo_nearest_neighbor_2d* spatial_sampler, mui_chrono_sampler_mean_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_mean_2dx( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t,
                                                   mui_sampler_pseudo_nearest_neighbor_2dx* spatial_sampler, mui_chrono_sampler_mean_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_mean_2t( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t,
                                                  mui_sampler_pseudo_nearest_neighbor_2t* spatial_sampler, mui_chrono_sampler_mean_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t),
                                      *spatial_sampler, *temporal_sampler ));
...
float mui_fetch_pseudo_nearest_neighbor_sum_2fx( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t,
                                                 mui_sampler_pseudo_nearest_neighbor_2fx* spatial_sampler, mui_chrono_sampler_sum_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t, *spatial_sampler, *temporal_sampler );
}
...
double mui_fetch_pseudo_nearest_neighbor_sum_2dx( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t,
                                                  mui_sampler_pseudo_nearest_neighbor_2dx* spatial_sampler, mui_chrono_sampler_sum_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t, *spatial_sampler, *temporal_sampler );
}
...
float mui_fetch_exact_exact_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                mui_sampler_exact_2f* spatial_sampler, mui_chrono_sampler_exact_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_exact_exact_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                      mui_sampler_exact_2fx* spatial_sampler, mui_chrono_sampler_exact_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_exact_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                      mui_sampler_exact_2d* spatial_sampler, mui_chrono_sampler_exact_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_exact_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                       mui_sampler_exact_2dx* spatial_sampler, mui_chrono_sampler_exact_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_exact_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                      mui_sampler_exact_2t* spatial_sampler, mui_chrono_sampler_exact_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
                                      static_cast<mui::mui_c_wrapper_2D::time_type>(t_2), *spatial_sampler, *temporal_sampler ));
  return result;
}
...
float mui_fetch_exact_gauss_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                      mui_sampler_exact_2fx* spatial_sampler, mui_chrono_sampler_gauss_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_gauss_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                      mui_sampler_exact_2d* spatial_sampler, mui_chrono_sampler_gauss_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_gauss_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                       mui_sampler_exact_2dx* spatial_sampler, mui_chrono_sampler_gauss_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_gauss_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                      mui_sampler_exact_2t* spatial_sampler, mui_chrono_sampler_gauss_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
float mui_fetch_exact_mean_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                     mui_sampler_exact_2fx* spatial_sampler, mui_chrono_sampler_mean_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_mean_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                     mui_sampler_exact_2d* spatial_sampler, mui_chrono_sampler_mean_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_mean_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                      mui_sampler_exact_2dx* spatial_sampler, mui_chrono_sampler_mean_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_mean_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                     mui_sampler_exact_2t* spatial_sampler, mui_chrono_sampler_mean_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
float mui_fetch_exact_sum_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                    mui_sampler_exact_2fx* spatial_sampler, mui_chrono_sampler_sum_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_sum_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                    mui_sampler_exact_2d* spatial_sampler, mui_chrono_sampler_sum_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_sum_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                     mui_sampler_exact_2dx* spatial_sampler, mui_chrono_sampler_sum_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_exact_sum_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                    mui_sampler_exact_2t* spatial_sampler, mui_chrono_sampler_sum_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
float mui_fetch_gauss_exact_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                      mui_sampler_gauss_2fx* spatial_sampler, mui_chrono_sampler_exact_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_exact_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                      mui_sampler_gauss_2d* spatial_sampler, mui_chrono_sampler_exact_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_exact_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                       mui_sampler_gauss_2dx* spatial_sampler, mui_chrono_sampler_exact_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_exact_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                      mui_sampler_gauss_2t* spatial_sampler, mui_chrono_sampler_exact_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
float mui_fetch_gauss_gauss_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                      mui_sampler_gauss_2fx* spatial_sampler, mui_chrono_sampler_gauss_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_gauss_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                      mui_sampler_gauss_2d* spatial_sampler, mui_chrono_sampler_gauss_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_gauss_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                       mui_sampler_gauss_2dx* spatial_sampler, mui_chrono_sampler_gauss_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_gauss_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                      mui_sampler_gauss_2t* spatial_sampler, mui_chrono_sampler_gauss_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
float mui_fetch_gauss_mean_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                     mui_sampler_gauss_2fx* spatial_sampler, mui_chrono_sampler_mean_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_mean_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                     mui_sampler_gauss_2d* spatial_sampler, mui_chrono_sampler_mean_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_mean_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                      mui_sampler_gauss_2dx* spatial_sampler, mui_chrono_sampler_mean_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_gauss_mean_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                     mui_sampler_gauss_2t* spatial_sampler, mui_chrono_sampler_mean_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: moving average; temporal sampler: exact
float mui_fetch_moving_average_exact_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                              mui_sampler_moving_average_2f* spatial_sampler, mui_chrono_sampler_exact_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_moving_average_exact_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                               mui_sampler_moving_average_2fx* spatial_sampler, mui_chrono_sampler_exact_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_exact_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                               mui_sampler_moving_average_2d* spatial_sampler, mui_chrono_sampler_exact_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_exact_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                                mui_sampler_moving_average_2dx* spatial_sampler, mui_chrono_sampler_exact_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_exact_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                               mui_sampler_moving_average_2t* spatial_sampler, mui_chrono_sampler_exact_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: moving average; temporal sampler: gauss
float mui_fetch_moving_average_gauss_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                              mui_sampler_moving_average_2f* spatial_sampler, mui_chrono_sampler_gauss_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_moving_average_gauss_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                               mui_sampler_moving_average_2fx* spatial_sampler, mui_chrono_sampler_gauss_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_gauss_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                               mui_sampler_moving_average_2d* spatial_sampler, mui_chrono_sampler_gauss_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_gauss_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                                mui_sampler_moving_average_2dx* spatial_sampler, mui_chrono_sampler_gauss_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_gauss_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                               mui_sampler_moving_average_2t* spatial_sampler, mui_chrono_sampler_gauss_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: moving average; temporal sampler: mean
float mui_fetch_moving_average_mean_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                             mui_sampler_moving_average_2f* spatial_sampler, mui_chrono_sampler_mean_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_moving_average_mean_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                              mui_sampler_moving_average_2fx* spatial_sampler, mui_chrono_sampler_mean_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_mean_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                              mui_sampler_moving_average_2d* spatial_sampler, mui_chrono_sampler_mean_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_mean_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                               mui_sampler_moving_average_2dx* spatial_sampler, mui_chrono_sampler_mean_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_mean_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                              mui_sampler_moving_average_2t* spatial_sampler, mui_chrono_sampler_mean_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: moving average; temporal sampler: sum
float mui_fetch_moving_average_sum_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                            mui_sampler_moving_average_2f* spatial_sampler, mui_chrono_sampler_sum_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_moving_average_sum_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                             mui_sampler_moving_average_2fx* spatial_sampler, mui_chrono_sampler_sum_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_sum_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                             mui_sampler_moving_average_2d* spatial_sampler, mui_chrono_sampler_sum_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_sum_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                              mui_sampler_moving_average_2dx* spatial_sampler, mui_chrono_sampler_sum_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_moving_average_sum_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                             mui_sampler_moving_average_2t* spatial_sampler, mui_chrono_sampler_sum_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: nearest neighbor; temporal sampler: exact
float mui_fetch_nearest_neighbor_exact_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                                mui_sampler_nearest_neighbor_2f* spatial_sampler, mui_chrono_sampler_exact_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_nearest_neighbor_exact_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                                 mui_sampler_nearest_neighbor_2fx* spatial_sampler, mui_chrono_sampler_exact_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_exact_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                                 mui_sampler_nearest_neighbor_2d* spatial_sampler, mui_chrono_sampler_exact_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_exact_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                                  mui_sampler_nearest_neighbor_2dx* spatial_sampler, mui_chrono_sampler_exact_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_exact_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                                 mui_sampler_nearest_neighbor_2t* spatial_sampler, mui_chrono_sampler_exact_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: nearest neighbor; temporal sampler: gauss
float mui_fetch_nearest_neighbor_gauss_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                                mui_sampler_nearest_neighbor_2f* spatial_sampler, mui_chrono_sampler_gauss_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_nearest_neighbor_gauss_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                                 mui_sampler_nearest_neighbor_2fx* spatial_sampler, mui_chrono_sampler_gauss_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_gauss_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                                 mui_sampler_nearest_neighbor_2d* spatial_sampler, mui_chrono_sampler_gauss_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_gauss_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                                  mui_sampler_nearest_neighbor_2dx* spatial_sampler, mui_chrono_sampler_gauss_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_gauss_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                                 mui_sampler_nearest_neighbor_2t* spatial_sampler, mui_chrono_sampler_gauss_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: nearest neighbor; temporal sampler: mean
float mui_fetch_nearest_neighbor_mean_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                               mui_sampler_nearest_neighbor_2f* spatial_sampler, mui_chrono_sampler_mean_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_nearest_neighbor_mean_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                                mui_sampler_nearest_neighbor_2fx* spatial_sampler, mui_chrono_sampler_mean_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_mean_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                                mui_sampler_nearest_neighbor_2d* spatial_sampler, mui_chrono_sampler_mean_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_mean_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                                 mui_sampler_nearest_neighbor_2dx* spatial_sampler, mui_chrono_sampler_mean_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_mean_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                                mui_sampler_nearest_neighbor_2t* spatial_sampler, mui_chrono_sampler_mean_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: nearest neighbor; temporal sampler: sum
float mui_fetch_nearest_neighbor_sum_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                              mui_sampler_nearest_neighbor_2f* spatial_sampler, mui_chrono_sampler_sum_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_nearest_neighbor_sum_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                               mui_sampler_nearest_neighbor_2fx* spatial_sampler, mui_chrono_sampler_sum_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_sum_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                               mui_sampler_nearest_neighbor_2d* spatial_sampler, mui_chrono_sampler_sum_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_sum_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                                mui_sampler_nearest_neighbor_2dx* spatial_sampler, mui_chrono_sampler_sum_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_nearest_neighbor_sum_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                               mui_sampler_nearest_neighbor_2t* spatial_sampler, mui_chrono_sampler_sum_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: nearest neighbor; temporal sampler: exact
float mui_fetch_pseudo_nearest_neighbor_exact_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                                       mui_sampler_pseudo_nearest_neighbor_2f* spatial_sampler, mui_chrono_sampler_exact_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_pseudo_nearest_neighbor_exact_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                                        mui_sampler_pseudo_nearest_neighbor_2fx* spatial_sampler, mui_chrono_sampler_exact_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_exact_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                                        mui_sampler_pseudo_nearest_neighbor_2d* spatial_sampler, mui_chrono_sampler_exact_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_exact_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                                         mui_sampler_pseudo_nearest_neighbor_2dx* spatial_sampler, mui_chrono_sampler_exact_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_exact_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                                        mui_sampler_pseudo_nearest_neighbor_2t* spatial_sampler, mui_chrono_sampler_exact_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: nearest neighbor; temporal sampler: gauss
float mui_fetch_pseudo_nearest_neighbor_gauss_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                                       mui_sampler_pseudo_nearest_neighbor_2f* spatial_sampler, mui_chrono_sampler_gauss_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_pseudo_nearest_neighbor_gauss_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                                        mui_sampler_pseudo_nearest_neighbor_2fx* spatial_sampler, mui_chrono_sampler_gauss_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_gauss_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                                        mui_sampler_pseudo_nearest_neighbor_2d* spatial_sampler, mui_chrono_sampler_gauss_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_gauss_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                                         mui_sampler_pseudo_nearest_neighbor_2dx* spatial_sampler, mui_chrono_sampler_gauss_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_gauss_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                                        mui_sampler_pseudo_nearest_neighbor_2t* spatial_sampler, mui_chrono_sampler_gauss_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: nearest neighbor; temporal sampler: mean
float mui_fetch_pseudo_nearest_neighbor_mean_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                                      mui_sampler_pseudo_nearest_neighbor_2f* spatial_sampler, mui_chrono_sampler_mean_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_pseudo_nearest_neighbor_mean_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                                       mui_sampler_pseudo_nearest_neighbor_2fx* spatial_sampler, mui_chrono_sampler_mean_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_mean_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                                       mui_sampler_pseudo_nearest_neighbor_2d* spatial_sampler, mui_chrono_sampler_mean_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_mean_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                                        mui_sampler_pseudo_nearest_neighbor_2dx* spatial_sampler, mui_chrono_sampler_mean_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_mean_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                                       mui_sampler_pseudo_nearest_neighbor_2t* spatial_sampler, mui_chrono_sampler_mean_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: nearest neighbor; temporal sampler: sum
float mui_fetch_pseudo_nearest_neighbor_sum_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                                     mui_sampler_pseudo_nearest_neighbor_2f* spatial_sampler, mui_chrono_sampler_sum_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_pseudo_nearest_neighbor_sum_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                                      mui_sampler_pseudo_nearest_neighbor_2fx* spatial_sampler, mui_chrono_sampler_sum_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_sum_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                                      mui_sampler_pseudo_nearest_neighbor_2d* spatial_sampler, mui_chrono_sampler_sum_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_sum_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                                       mui_sampler_pseudo_nearest_neighbor_2dx* spatial_sampler, mui_chrono_sampler_sum_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_pseudo_nearest_neighbor_sum_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                                      mui_sampler_pseudo_nearest_neighbor_2t* spatial_sampler, mui_chrono_sampler_sum_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: shepard quintic; temporal sampler: exact
float mui_fetch_shepard_quintic_exact_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                               mui_sampler_shepard_quintic_2f* spatial_sampler, mui_chrono_sampler_exact_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_shepard_quintic_exact_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                                mui_sampler_shepard_quintic_2fx* spatial_sampler, mui_chrono_sampler_exact_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_exact_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                                mui_sampler_shepard_quintic_2d* spatial_sampler, mui_chrono_sampler_exact_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_exact_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                                 mui_sampler_shepard_quintic_2dx* spatial_sampler, mui_chrono_sampler_exact_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_exact_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                                mui_sampler_shepard_quintic_2t* spatial_sampler, mui_chrono_sampler_exact_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: shepard quintic; temporal sampler: gauss
float mui_fetch_shepard_quintic_gauss_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                               mui_sampler_shepard_quintic_2f* spatial_sampler, mui_chrono_sampler_gauss_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_shepard_quintic_gauss_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                                mui_sampler_shepard_quintic_2fx* spatial_sampler, mui_chrono_sampler_gauss_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_gauss_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                                mui_sampler_shepard_quintic_2d* spatial_sampler, mui_chrono_sampler_gauss_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_gauss_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                                 mui_sampler_shepard_quintic_2dx* spatial_sampler, mui_chrono_sampler_gauss_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_gauss_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                                mui_sampler_shepard_quintic_2t* spatial_sampler, mui_chrono_sampler_gauss_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: shepard quintic; temporal sampler: mean
float mui_fetch_shepard_quintic_mean_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                              mui_sampler_shepard_quintic_2f* spatial_sampler, mui_chrono_sampler_mean_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_shepard_quintic_mean_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                               mui_sampler_shepard_quintic_2fx* spatial_sampler, mui_chrono_sampler_mean_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_mean_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                               mui_sampler_shepard_quintic_2d* spatial_sampler, mui_chrono_sampler_mean_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_mean_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                                mui_sampler_shepard_quintic_2dx* spatial_sampler, mui_chrono_sampler_mean_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_mean_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                               mui_sampler_shepard_quintic_2t* spatial_sampler, mui_chrono_sampler_mean_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: shepard quintic; temporal sampler: sum
float mui_fetch_shepard_quintic_sum_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                             mui_sampler_shepard_quintic_2f* spatial_sampler, mui_chrono_sampler_sum_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_shepard_quintic_sum_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                              mui_sampler_shepard_quintic_2fx* spatial_sampler, mui_chrono_sampler_sum_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_sum_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                              mui_sampler_shepard_quintic_2d* spatial_sampler, mui_chrono_sampler_sum_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_sum_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                               mui_sampler_shepard_quintic_2dx* spatial_sampler, mui_chrono_sampler_sum_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_shepard_quintic_sum_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                              mui_sampler_shepard_quintic_2t* spatial_sampler, mui_chrono_sampler_sum_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: sph-derived quintic; temporal sampler: exact
float mui_fetch_sph_quintic_exact_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                           mui_sampler_sph_quintic_2f* spatial_sampler, mui_chrono_sampler_exact_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sph_quintic_exact_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                            mui_sampler_sph_quintic_2fx* spatial_sampler, mui_chrono_sampler_exact_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_exact_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                            mui_sampler_sph_quintic_2d* spatial_sampler, mui_chrono_sampler_exact_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_exact_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                             mui_sampler_sph_quintic_2dx* spatial_sampler, mui_chrono_sampler_exact_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_exact_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                            mui_sampler_sph_quintic_2t* spatial_sampler, mui_chrono_sampler_exact_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: sph-derived quintic; temporal sampler: gauss
float mui_fetch_sph_quintic_gauss_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                           mui_sampler_sph_quintic_2f* spatial_sampler, mui_chrono_sampler_gauss_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sph_quintic_gauss_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                            mui_sampler_sph_quintic_2fx* spatial_sampler, mui_chrono_sampler_gauss_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_gauss_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                            mui_sampler_sph_quintic_2d* spatial_sampler, mui_chrono_sampler_gauss_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_gauss_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                             mui_sampler_sph_quintic_2dx* spatial_sampler, mui_chrono_sampler_gauss_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_gauss_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                            mui_sampler_sph_quintic_2t* spatial_sampler, mui_chrono_sampler_gauss_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: sph-derived quintic; temporal sampler: mean
float mui_fetch_sph_quintic_mean_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                          mui_sampler_sph_quintic_2f* spatial_sampler, mui_chrono_sampler_mean_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sph_quintic_mean_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                           mui_sampler_sph_quintic_2fx* spatial_sampler, mui_chrono_sampler_mean_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_mean_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                           mui_sampler_sph_quintic_2d* spatial_sampler, mui_chrono_sampler_mean_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_mean_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                            mui_sampler_sph_quintic_2dx* spatial_sampler, mui_chrono_sampler_mean_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_mean_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                           mui_sampler_sph_quintic_2t* spatial_sampler, mui_chrono_sampler_mean_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: sph-derived quintic; temporal sampler: sum
float mui_fetch_sph_quintic_sum_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                         mui_sampler_sph_quintic_2f* spatial_sampler, mui_chrono_sampler_sum_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sph_quintic_sum_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                          mui_sampler_sph_quintic_2fx* spatial_sampler, mui_chrono_sampler_sum_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_sum_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                          mui_sampler_sph_quintic_2d* spatial_sampler, mui_chrono_sampler_sum_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_sum_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                           mui_sampler_sph_quintic_2dx* spatial_sampler, mui_chrono_sampler_sum_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sph_quintic_sum_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                          mui_sampler_sph_quintic_2t* spatial_sampler, mui_chrono_sampler_sum_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: summation quintic; temporal sampler: exact
float mui_fetch_sum_quintic_exact_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                           mui_sampler_sum_quintic_2f* spatial_sampler, mui_chrono_sampler_exact_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sum_quintic_exact_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                            mui_sampler_sum_quintic_2fx* spatial_sampler, mui_chrono_sampler_exact_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_exact_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                            mui_sampler_sum_quintic_2d* spatial_sampler, mui_chrono_sampler_exact_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_exact_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                             mui_sampler_sum_quintic_2dx* spatial_sampler, mui_chrono_sampler_exact_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_exact_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                            mui_sampler_sum_quintic_2t* spatial_sampler, mui_chrono_sampler_exact_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: summation quintic; temporal sampler: gauss
float mui_fetch_sum_quintic_gauss_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                           mui_sampler_sum_quintic_2f* spatial_sampler, mui_chrono_sampler_gauss_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sum_quintic_gauss_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                            mui_sampler_sum_quintic_2fx* spatial_sampler, mui_chrono_sampler_gauss_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_gauss_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                            mui_sampler_sum_quintic_2d* spatial_sampler, mui_chrono_sampler_gauss_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_gauss_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                             mui_sampler_sum_quintic_2dx* spatial_sampler, mui_chrono_sampler_gauss_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_gauss_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                            mui_sampler_sum_quintic_2t* spatial_sampler, mui_chrono_sampler_gauss_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: summation quintic; temporal sampler: mean
float mui_fetch_sum_quintic_mean_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                          mui_sampler_sum_quintic_2f* spatial_sampler, mui_chrono_sampler_mean_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sum_quintic_mean_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                           mui_sampler_sum_quintic_2fx* spatial_sampler, mui_chrono_sampler_mean_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_mean_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                           mui_sampler_sum_quintic_2d* spatial_sampler, mui_chrono_sampler_mean_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_mean_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                            mui_sampler_sum_quintic_2dx* spatial_sampler, mui_chrono_sampler_mean_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_mean_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                           mui_sampler_sum_quintic_2t* spatial_sampler, mui_chrono_sampler_mean_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
// Spatial sampler: summation quintic; temporal sampler: sum
float mui_fetch_sum_quintic_sum_2f_pair( mui_uniface_2f* uniface, const char *attr, mui_point_2f point, float t_1, float t_2,
                                         mui_sampler_sum_quintic_2f* spatial_sampler, mui_chrono_sampler_sum_2f* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2f(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

float mui_fetch_sum_quintic_sum_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                          mui_sampler_sum_quintic_2fx* spatial_sampler, mui_chrono_sampler_sum_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_sum_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                          mui_sampler_sum_quintic_2d* spatial_sampler, mui_chrono_sampler_sum_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_sum_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                           mui_sampler_sum_quintic_2dx* spatial_sampler, mui_chrono_sampler_sum_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_sum_quintic_sum_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                          mui_sampler_sum_quintic_2t* spatial_sampler, mui_chrono_sampler_sum_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
float mui_fetch_rbf_exact_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                    mui_sampler_rbf_2fx* spatial_sampler, mui_chrono_sampler_exact_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_rbf_exact_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                    mui_sampler_rbf_2d* spatial_sampler, mui_chrono_sampler_exact_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_rbf_exact_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                     mui_sampler_rbf_2dx* spatial_sampler, mui_chrono_sampler_exact_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_rbf_exact_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                    mui_sampler_rbf_2t* spatial_sampler, mui_chrono_sampler_exact_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
float mui_fetch_rbf_gauss_2fx_pair( mui_uniface_2fx* uniface, const char *attr, mui_point_2fx point, float t_1, float t_2,
                                    mui_sampler_rbf_2fx* spatial_sampler, mui_chrono_sampler_gauss_2fx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2fx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_rbf_gauss_2d_pair( mui_uniface_2d* uniface, const char *attr, mui_point_2d point, double t_1, double t_2,
                                    mui_sampler_rbf_2d* spatial_sampler, mui_chrono_sampler_gauss_2d* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2d(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_rbf_gauss_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                     mui_sampler_rbf_2dx* spatial_sampler, mui_chrono_sampler_gauss_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}

double mui_fetch_rbf_gauss_2t_pair( mui_uniface_2t* uniface, const char *attr, mui_point_2t point, double t_1, double t_2,
                                    mui_sampler_rbf_2t* spatial_sampler, mui_chrono_sampler_gauss_2t* temporal_sampler ) {
  mui::mui_c_wrapper_2D::point_type point_fetch( static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_1),
                                                 static_cast<mui::mui_c_wrapper_2D::REAL>(point.point_2) );
  double result = static_cast<double>(uniface->fetch( std::string(attr), point_fetch, static_cast<mui::mui_c_wrapper_2D::time_type>(t_1),
...
double mui_fetch_rbf_mean_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                    mui_sampler_rbf_2dx* spatial_sampler, mui_chrono_sampler_mean_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}
...
double mui_fetch_rbf_sum_2dx_pair( mui_uniface_2dx* uniface, const char *attr, mui_point_2dx point, double t_1, double t_2,
                                   mui_sampler_rbf_2dx* spatial_sampler, mui_chrono_sampler_sum_2dx* temporal_sampler ) {
  return uniface->fetch( std::string(attr), mui::point2dx(point.point_1, point.point_2), t_1, t_2, *spatial_sampler, *temporal_sampler );
}
...
void mui_fetch_points_exact_2f( mui_uniface_2f* uniface, const char *attr, float t, mui_chrono_sampler_exact_2f* temporal_sampler, mui_point_2f* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_2fx( mui_uniface_2fx* uniface, const char *attr, float t, mui_chrono_sampler_exact_2fx* temporal_sampler, mui_point_2fx* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_2d( mui_uniface_2d* uniface, const char *attr, double t, mui_chrono_sampler_exact_2d* temporal_sampler, mui_point_2d* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_2dx( mui_uniface_2dx* uniface, const char *attr, double t, mui_chrono_sampler_exact_2dx* temporal_sampler, mui_point_2dx* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_2t( mui_uniface_2t* uniface, const char *attr, double t, mui_chrono_sampler_exact_2t* temporal_sampler, mui_point_2t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_2D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
...
void mui_fetch_points_gauss_2f( mui_uniface_2f* uniface, const char *attr, float t, mui_chrono_sampler_gauss_2f* temporal_sampler, mui_point_2f* ret_points, int* num_points ) {
  std::vector<mui::point2f> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_2f*)malloc( ret_pts.size() * sizeof(mui_point_2f) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_2fx( mui_uniface_2fx* uniface, const char *attr, float t, mui_chrono_sampler_gauss_2fx* temporal_sampler, mui_point_2fx* ret_points, int* num_points ) {
  std::vector<mui::point2fx> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_2fx*)malloc( ret_pts.size() * sizeof(mui_point_2fx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_2d( mui_uniface_2d* uniface, const char *attr, double t, mui_chrono_sampler_gauss_2d* temporal_sampler, mui_point_2d* ret_points, int* num_points ) {
  std::vector<mui::point2d> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_2d*)malloc( ret_pts.size() * sizeof(mui_point_2d) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_2dx( mui_uniface_2dx* uniface, const char *attr, double t, mui_chrono_sampler_gauss_2dx* temporal_sampler, mui_point_2dx* ret_points, int* num_points ) {
  std::vector<mui::point2dx> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_2dx*)malloc( ret_pts.size() * sizeof(mui_point_2dx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_2t( mui_uniface_2t* uniface, const char *attr, double t, mui_chrono_sampler_gauss_2t* temporal_sampler, mui_point_2t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_2D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_2t*)malloc( ret_pts.size() * sizeof(mui_point_2t) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = static_cast<double>(ret_pts[i][0]);
...
void mui_fetch_points_mean_2f( mui_uniface_2f* uniface, const char *attr, float t, mui_chrono_sampler_mean_2f* temporal_sampler, mui_point_2f* ret_points, int* num_points ) {
  std::vector<mui::point2f> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_2f*)malloc( ret_pts.size() * sizeof(mui_point_2f) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_2fx( mui_uniface_2fx* uniface, const char *attr, float t, mui_chrono_sampler_mean_2fx* temporal_sampler, mui_point_2fx* ret_points, int* num_points ) {
  std::vector<mui::point2fx> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_2fx*)malloc( ret_pts.size() * sizeof(mui_point_2fx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_2d( mui_uniface_2d* uniface, const char *attr, double t, mui_chrono_sampler_mean_2d* temporal_sampler, mui_point_2d* ret_points, int* num_points ) {
  std::vector<mui::point2d> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_2d*)malloc( ret_pts.size() * sizeof(mui_point_2d) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_2dx( mui_uniface_2dx* uniface, const char *attr, double t, mui_chrono_sampler_mean_2dx* temporal_sampler, mui_point_2dx* ret_points, int* num_points ) {
  std::vector<mui::point2dx> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_2dx*)malloc( ret_pts.size() * sizeof(mui_point_2dx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_2t( mui_uniface_2t* uniface, const char *attr, double t, mui_chrono_sampler_mean_2t* temporal_sampler, mui_point_2t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_2D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_2t*)malloc( ret_pts.size() * sizeof(mui_point_2t) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = static_cast<double>(ret_pts[i][0]);
...
void mui_fetch_points_sum_2f( mui_uniface_2f* uniface, const char *attr, float t, mui_chrono_sampler_sum_2f* temporal_sampler, mui_point_2f* ret_points, int* num_points ) {
  std::vector<mui::point2f> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_2f*)malloc( ret_pts.size() * sizeof(mui_point_2f) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_2fx( mui_uniface_2fx* uniface, const char *attr, float t, mui_chrono_sampler_sum_2fx* temporal_sampler, mui_point_2fx* ret_points, int* num_points ) {
  std::vector<mui::point2fx> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_2fx*)malloc( ret_pts.size() * sizeof(mui_point_2fx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_2d( mui_uniface_2d* uniface, const char *attr, double t, mui_chrono_sampler_sum_2d* temporal_sampler, mui_point_2d* ret_points, int* num_points ) {
  std::vector<mui::point2d> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_2d*)malloc( ret_pts.size() * sizeof(mui_point_2d) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_2dx( mui_uniface_2dx* uniface, const char *attr, double t, mui_chrono_sampler_sum_2dx* temporal_sampler, mui_point_2dx* ret_points, int* num_points ) {
  std::vector<mui::point2dx> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_2dx*)malloc( ret_pts.size() * sizeof(mui_point_2dx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_2t( mui_uniface_2t* uniface, const char *attr, double t, mui_chrono_sampler_sum_2t* temporal_sampler, mui_point_2t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_2D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t, *temporal_sampler );
  ret_points = (mui_point_2t*)malloc( ret_pts.size() * sizeof(mui_point_2t) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = static_cast<double>(ret_pts[i][0]);
...
// Temporal sampler: exact
void mui_fetch_points_exact_2f_pair( mui_uniface_2f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_exact_2f* temporal_sampler, mui_point_2f* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_2fx_pair( mui_uniface_2fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_exact_2fx* temporal_sampler, mui_point_2fx* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_2d_pair( mui_uniface_2d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_exact_2d* temporal_sampler, mui_point_2d* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_2dx_pair( mui_uniface_2dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_exact_2dx* temporal_sampler, mui_point_2dx* ret_points, int* num_points ) {
...
void mui_fetch_points_exact_2t_pair( mui_uniface_2t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_exact_2t* temporal_sampler, mui_point_2t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_2D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2t*)malloc( ret_pts.size() * sizeof(mui_point_2t) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = static_cast<double>(ret_pts[i][0]);
    ret_points[i].point_2 = static_cast<double>(ret_pts[i][1]);
...
// Temporal sampler: gauss
void mui_fetch_points_gauss_2f_pair( mui_uniface_2f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_gauss_2f* temporal_sampler, mui_point_2f* ret_points, int* num_points ) {
  std::vector<mui::point2f> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2f*)malloc( ret_pts.size() * sizeof(mui_point_2f) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_2fx_pair( mui_uniface_2fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_gauss_2fx* temporal_sampler, mui_point_2fx* ret_points, int* num_points ) {
  std::vector<mui::point2fx> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2fx*)malloc( ret_pts.size() * sizeof(mui_point_2fx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_2d_pair( mui_uniface_2d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_gauss_2d* temporal_sampler, mui_point_2d* ret_points, int* num_points ) {
  std::vector<mui::point2d> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2d*)malloc( ret_pts.size() * sizeof(mui_point_2d) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_2dx_pair( mui_uniface_2dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_gauss_2dx* temporal_sampler, mui_point_2dx* ret_points, int* num_points ) {
  std::vector<mui::point2dx> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2dx*)malloc( ret_pts.size() * sizeof(mui_point_2dx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_gauss_2t_pair( mui_uniface_2t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_gauss_2t* temporal_sampler, mui_point_2t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_2D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2t*)malloc( ret_pts.size() * sizeof(mui_point_2t) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = static_cast<double>(ret_pts[i][0]);
...
// Temporal sampler: mean
void mui_fetch_points_mean_2f_pair( mui_uniface_2f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_mean_2f* temporal_sampler, mui_point_2f* ret_points, int* num_points ) {
  std::vector<mui::point2f> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2f*)malloc( ret_pts.size() * sizeof(mui_point_2f) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_2fx_pair( mui_uniface_2fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_mean_2fx* temporal_sampler, mui_point_2fx* ret_points, int* num_points ) {
  std::vector<mui::point2fx> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2fx*)malloc( ret_pts.size() * sizeof(mui_point_2fx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_2d_pair( mui_uniface_2d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_mean_2d* temporal_sampler, mui_point_2d* ret_points, int* num_points ) {
  std::vector<mui::point2d> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2d*)malloc( ret_pts.size() * sizeof(mui_point_2d) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_2dx_pair( mui_uniface_2dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_mean_2dx* temporal_sampler, mui_point_2dx* ret_points, int* num_points ) {
  std::vector<mui::point2dx> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2dx*)malloc( ret_pts.size() * sizeof(mui_point_2dx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_mean_2t_pair( mui_uniface_2t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_mean_2t* temporal_sampler, mui_point_2t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_2D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2t*)malloc( ret_pts.size() * sizeof(mui_point_2t) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = static_cast<double>(ret_pts[i][0]);
...
// Temporal sampler: sum
void mui_fetch_points_sum_2f_pair( mui_uniface_2f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_sum_2f* temporal_sampler, mui_point_2f* ret_points, int* num_points ) {
  std::vector<mui::point2f> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2f*)malloc( ret_pts.size() * sizeof(mui_point_2f) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_2fx_pair( mui_uniface_2fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_sum_2fx* temporal_sampler, mui_point_2fx* ret_points, int* num_points ) {
  std::vector<mui::point2fx> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2fx*)malloc( ret_pts.size() * sizeof(mui_point_2fx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_2d_pair( mui_uniface_2d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_sum_2d* temporal_sampler, mui_point_2d* ret_points, int* num_points ) {
  std::vector<mui::point2d> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2d*)malloc( ret_pts.size() * sizeof(mui_point_2d) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_2dx_pair( mui_uniface_2dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_sum_2dx* temporal_sampler, mui_point_2dx* ret_points, int* num_points ) {
  std::vector<mui::point2dx> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2dx*)malloc( ret_pts.size() * sizeof(mui_point_2dx) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = ret_pts[i][0];
...
void mui_fetch_points_sum_2t_pair( mui_uniface_2t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_sum_2t* temporal_sampler, mui_point_2t* ret_points, int* num_points ) {
  std::vector<mui::mui_c_wrapper_2D::point_type> ret_pts = uniface->fetch_points<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  ret_points = (mui_point_2t*)malloc( ret_pts.size() * sizeof(mui_point_2t) );
  for( size_t i=0; i<ret_pts.size(); i++) {
    ret_points[i].point_1 = static_cast<double>(ret_pts[i][0]);
...
// Temporal sampler: exact
void mui_fetch_values_exact_2f( mui_uniface_2f* uniface, const char *attr, float t, mui_chrono_sampler_exact_2f* temporal_sampler, float* values, int* num_values ) {
...
void mui_fetch_values_exact_2fx( mui_uniface_2fx* uniface, const char *attr, float t, mui_chrono_sampler_exact_2fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_exact_2d( mui_uniface_2d* uniface, const char *attr, double t, mui_chrono_sampler_exact_2d* temporal_sampler, double* values, int* num_values ) {
...
void mui_fetch_values_exact_2dx( mui_uniface_2dx* uniface, const char *attr, double t, mui_chrono_sampler_exact_2dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_exact_2t( mui_uniface_2t* uniface, const char *attr, double t, mui_chrono_sampler_exact_2t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_2D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_2D::REAL>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
...
// Temporal sampler: gauss
void mui_fetch_values_gauss_2f( mui_uniface_2f* uniface, const char *attr, float t, mui_chrono_sampler_gauss_2f* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_2fx( mui_uniface_2fx* uniface, const char *attr, float t, mui_chrono_sampler_gauss_2fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_2d( mui_uniface_2d* uniface, const char *attr, double t, mui_chrono_sampler_gauss_2d* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_2dx( mui_uniface_2dx* uniface, const char *attr, double t, mui_chrono_sampler_gauss_2dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_2t( mui_uniface_2t* uniface, const char *attr, double t, mui_chrono_sampler_gauss_2t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_2D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_2D::REAL>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = static_cast<double>(ret_vals[i]);
...
// Temporal sampler: mean
void mui_fetch_values_mean_2f( mui_uniface_2f* uniface, const char *attr, float t, mui_chrono_sampler_mean_2f* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_2fx( mui_uniface_2fx* uniface, const char *attr, float t, mui_chrono_sampler_mean_2fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_2d( mui_uniface_2d* uniface, const char *attr, double t, mui_chrono_sampler_mean_2d* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_2dx( mui_uniface_2dx* uniface, const char *attr, double t, mui_chrono_sampler_mean_2dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_2t( mui_uniface_2t* uniface, const char *attr, double t, mui_chrono_sampler_mean_2t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_2D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_2D::REAL>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = static_cast<double>(ret_vals[i]);
...
// Temporal sampler: sum
void mui_fetch_values_sum_2f( mui_uniface_2f* uniface, const char *attr, float t, mui_chrono_sampler_sum_2f* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_2fx( mui_uniface_2fx* uniface, const char *attr, float t, mui_chrono_sampler_sum_2fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_2d( mui_uniface_2d* uniface, const char *attr, double t, mui_chrono_sampler_sum_2d* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_2dx( mui_uniface_2dx* uniface, const char *attr, double t, mui_chrono_sampler_sum_2dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_2t( mui_uniface_2t* uniface, const char *attr, double t, mui_chrono_sampler_sum_2t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_2D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_2D::REAL>( std::string(attr), t, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = static_cast<double>(ret_vals[i]);
...
// Temporal sampler: exact
void mui_fetch_values_exact_2f_pair( mui_uniface_2f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_exact_2f* temporal_sampler, float* values, int* num_values ) {
...
void mui_fetch_values_exact_2fx_pair( mui_uniface_2fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_exact_2fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_exact_2d_pair( mui_uniface_2d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_exact_2d* temporal_sampler, double* values, int* num_values ) {
...
void mui_fetch_values_exact_2dx_pair( mui_uniface_2dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_exact_2dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_exact_2t_pair( mui_uniface_2t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_exact_2t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_2D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_2D::REAL>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = static_cast<double>(ret_vals[i]);
  }
...
// Temporal sampler: gauss
void mui_fetch_values_gauss_2f_pair( mui_uniface_2f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_gauss_2f* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_2fx_pair( mui_uniface_2fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_gauss_2fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_2d_pair( mui_uniface_2d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_gauss_2d* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_2dx_pair( mui_uniface_2dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_gauss_2dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_gauss_2t_pair( mui_uniface_2t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_gauss_2t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_2D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_2D::REAL>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = static_cast<double>(ret_vals[i]);
...
// Temporal sampler: mean
void mui_fetch_values_mean_2f_pair( mui_uniface_2f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_mean_2f* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_2fx_pair( mui_uniface_2fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_mean_2fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_2d_pair( mui_uniface_2d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_mean_2d* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_2dx_pair( mui_uniface_2dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_mean_2dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_mean_2t_pair( mui_uniface_2t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_mean_2t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_2D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_2D::REAL>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = static_cast<double>(ret_vals[i]);
...
// Temporal sampler: sum
void mui_fetch_values_sum_2f_pair( mui_uniface_2f* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_sum_2f* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_2fx_pair( mui_uniface_2fx* uniface, const char *attr, float t_1, float t_2, mui_chrono_sampler_sum_2fx* temporal_sampler, float* values, int* num_values ) {
  std::vector<float> ret_vals = uniface->fetch_values<float>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (float*)malloc( ret_vals.size() * sizeof(float) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_2d_pair( mui_uniface_2d* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_sum_2d* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_2dx_pair( mui_uniface_2dx* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_sum_2dx* temporal_sampler, double* values, int* num_values ) {
  std::vector<double> ret_vals = uniface->fetch_values<double>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = ret_vals[i];
...
void mui_fetch_values_sum_2t_pair( mui_uniface_2t* uniface, const char *attr, double t_1, double t_2, mui_chrono_sampler_sum_2t* temporal_sampler, double* values, int* num_values ) {
  std::vector<mui::mui_c_wrapper_2D::REAL> ret_vals = uniface->fetch_values<mui::mui_c_wrapper_2D::REAL>( std::string(attr), t_1, t_2, *temporal_sampler );
  values = (double*)malloc( ret_vals.size() * sizeof(double) );
  for( size_t i=0; i<ret_vals.size(); i++) {
    values[i] = static_cast<double>(ret_vals[i]);
...
int mui_is_ready_2t_pair( mui_uniface_2t* uniface, const char *attr, double t_1, double t_2 ) {
  return uniface->is_ready( std::string(attr), static_cast<mui::mui_c_wrapper_2D::time_type>(t_1), static_cast<mui::mui_c_wrapper_2D::time_type>(t_2) );
}
...
void mui_announce_send_span_2f_box( mui_uniface_2f* uniface, float box_1_1, float box_1_2, float box_2_1, float box_2_2, float t_start, float t_timeout ) {
...
void mui_announce_send_span_2fx_box( mui_uniface_2fx* uniface, float box_1_1, float box_1_2, float box_2_1, float box_2_2, float t_start, float t_timeout ) {
...
void mui_announce_send_span_2d_box( mui_uniface_2d* uniface, double box_1_1, double box_1_2, double box_2_1, double box_2_2, double t_start, double t_timeout ) {
...
void mui_announce_send_span_2dx_box( mui_uniface_2dx* uniface, double box_1_1, double box_1_2, double box_2_1, double box_2_2, double t_start, double t_timeout ) {
...
void mui_announce_send_span_2t_box( mui_uniface_2t* uniface, double box_1_1, double box_1_2, double box_2_1, double box_2_2, double t_start, double t_timeout ) {
  mui::mui_c_wrapper_2D::point_type point_1(static_cast<mui::mui_c_wrapper_2D::REAL>(box_1_1), static_cast<mui::mui_c_wrapper_2D::REAL>(box_1_2));
  mui::mui_c_wrapper_2D::point_type point_2(static_cast<mui::mui_c_wrapper_2D::REAL>(box_2_1), static_cast<mui::mui_c_wrapper_2D::REAL>(box_2_2));
  mui::geometry::box<mui::mui_c_wrapper_2D> bound_box( point_1, point_2 );
  uniface->announce_send_span(static_cast<mui::mui_c_wrapper_2D::time_type>(t_start), static_cast<mui::mui_c_wrapper_2D::time_type>(t_timeout), bound_box);
}

// Send span announce using 2D sphere geometry
void mui_announce_send_span_2f_sphere( mui_uniface_2f* uniface, mui_point_2f centre, float radius, float t_start, float t_timeout ) {
...
void mui_announce_send_span_2fx_sphere( mui_uniface_2fx* uniface, mui_point_2fx centre, float radius, float t_start, float t_timeout ) {
  mui::geometry::sphere2fx bound_sphere( mui::point2fx(centre.point_1, centre.point_2), radius );
  uniface->announce_send_span(t_start, t_timeout, bound_sphere);
}

void mui_announce_send_span_2d_sphere( mui_uniface_2d* uniface, mui_point_2d centre, double radius, double t_start, double t_timeout ) {
  mui::geometry::sphere2d bound_sphere( mui::point2d(centre.point_1, centre.point_2), radius );
  uniface->announce_send_span(t_start, t_timeout, bound_sphere);
}

void mui_announce_send_span_2dx_sphere( mui_uniface_2dx* uniface, mui_point_2dx centre, double radius, double t_start, double t_timeout ) {
  mui::geometry::sphere2dx bound_sphere( mui::point2dx(centre.point_1, centre.point_2), radius );
  uniface->announce_send_span(t_start, t_timeout, bound_sphere);
}

void mui_announce_send_span_2t_sphere( mui_uniface_2t* uniface, mui_point_2t centre, double radius, double t_start, double t_timeout ) {
  mui::geometry::sphere<mui::mui_c_wrapper_2D> bound_sphere( mui::mui_c_wrapper_2D::point_type(static_cast<mui::mui_c_wrapper_2D::REAL>(centre.point_1),
                                                                                               static_cast<mui::mui_c_wrapper_2D::REAL>(centre.point_2)),
                                                             static_cast<mui::mui_c_wrapper_2D::REAL>(radius) );
  uniface->announce_send_span(static_cast<mui::mui_c_wrapper_2D::time_type>(t_start), static_cast<mui::mui_c_wrapper_2D::time_type>(t_timeout), bound_sphere);
}

// Receive span announce using 2D box geometry
void mui_announce_recv_span_2f_box( mui_uniface_2f* uniface, float box_1_1, float box_1_2, float box_2_1, float box_2_2, float t_start, float t_timeout ) {
  mui::point2f point_1(box_1_1, box_1_2);
  mui::point2f point_2(box_2_1, box_2_2);
  mui::geometry::box2f bound_box( point_1, point_2 );
...
void mui_announce_recv_span_2fx_box( mui_uniface_2fx* uniface, float box_1_1, float box_1_2, float box_2_1, float box_2_2, float t_start, float t_timeout ) {
  mui::point2fx point_1(box_1_1, box_1_2);
  mui::point2fx point_2(box_2_1, box_2_2);
  mui::geometry::box2fx bound_box( point_1, point_2 );
  uniface->announce_recv_span(t_start, t_timeout, bound_box);
...
void mui_announce_recv_span_2d_box( mui_uniface_2d* uniface, double box_1_1, double box_1_2, double box_2_1, double box_2_2, double t_start, double t_timeout ) {
  mui::point2d point_1(box_1_1, box_1_2);
  mui::point2d point_2(box_2_1, box_2_2);
  mui::geometry::box2d bound_box( point_1, point_2 );
  uniface->announce_recv_span(t_start, t_timeout, bound_box);
...
void mui_announce_recv_span_2dx_box( mui_uniface_2dx* uniface, double box_1_1, double box_1_2, double box_2_1, double box_2_2, double t_start, double t_timeout ) {
  mui::point2dx point_1(box_1_1, box_1_2);
  mui::point2dx point_2(box_2_1, box_2_2);
  mui::geometry::box2dx bound_box( point_1, point_2 );
  uniface->announce_recv_span(t_start, t_timeout, bound_box);
...
void mui_announce_recv_span_2t_box( mui_uniface_2t* uniface, double box_1_1, double box_1_2, double box_2_1, double box_2_2, double t_start, double t_timeout ) {
  mui::mui_c_wrapper_2D::point_type point_1(static_cast<mui::mui_c_wrapper_2D::REAL>(box_1_1), static_cast<mui::mui_c_wrapper_2D::REAL>(box_1_2));
  mui::mui_c_wrapper_2D::point_type point_2(static_cast<mui::mui_c_wrapper_2D::REAL>(box_2_1), static_cast<mui::mui_c_wrapper_2D::REAL>(box_2_2));
  mui::geometry::box<mui::mui_c_wrapper_2D> bound_box( point_1, point_2 );
  uniface->announce_recv_span(static_cast<mui::mui_c_wrapper_2D::time_type>(t_start), static_cast<mui::mui_c_wrapper_2D::time_type>(t_timeout), bound_box);
}

// Receive span announce using 1D sphere geometry
void mui_announce_recv_span_2f_sphere( mui_uniface_2f* uniface, mui_point_2f centre, float radius, float t_start, float t_timeout ) {
  mui::geometry::sphere2f bound_sphere( mui::point2f(centre.point_1, centre.point_2), radius );
  uniface->announce_recv_span(t_start, t_timeout, bound_sphere);
}

void mui_announce_recv_span_2fx_sphere( mui_uniface_2fx* uniface, mui_point_2fx centre, float radius, float t_start, float t_timeout ) {
  mui::geometry::sphere2fx bound_sphere( mui::point2fx(centre.point_1, centre.point_2), radius );
  uniface->announce_recv_span(t_start, t_timeout, bound_sphere);
}

void mui_announce_recv_span_2d_sphere( mui_uniface_2d* uniface, mui_point_2d centre, double radius, double t_start, double t_timeout ) {
  mui::geometry::sphere2d bound_sphere( mui::point2d(centre.point_1, centre.point_2), radius );
  uniface->announce_recv_span(t_start, t_timeout, bound_sphere);
}

void mui_announce_recv_span_2dx_sphere( mui_uniface_2dx* uniface, mui_point_2dx centre, double radius, double t_start, double t_timeout ) {
  mui::geometry::sphere2dx bound_sphere( mui::point2dx(centre.point_1, centre.point_2), radius );
  uniface->announce_recv_span(t_start, t_timeout, bound_sphere);
}

void mui_announce_recv_span_2t_sphere( mui_uniface_2t* uniface, mui_point_2t centre, double radius, double t_start, double t_timeout ) {
  mui::geometry::sphere<mui::mui_c_wrapper_2D> bound_sphere( mui::mui_c_wrapper_2D::point_type(static_cast<mui::mui_c_wrapper_2D::REAL>(centre.point_1),
                                                                                               static_cast<mui::mui_c_wrapper_2D::REAL>(centre.point_2)),
                                                             static_cast<mui::mui_c_wrapper_2D::REAL>(radius) );
  uniface->announce_recv_span(static_cast<mui::mui_c_wrapper_2D::time_type>(t_start), static_cast<mui::mui_c_wrapper_2D::time_type>(t_timeout), bound_sphere);
}
...
void mui_barrier_2t_pair( mui_uniface_2t* uniface, double t_1, double t_2 ) {
  uniface->barrier(static_cast<mui::mui_c_wrapper_2D::time_type>(t_1), static_cast<mui::mui_c_wrapper_2D::time_type>(t_2));
}
...
void mui_forget_lower_upper_2f_pair( mui_uniface_2f* uniface, float lower_1, float lower_2, float upper_1, float upper_2, int reset_log ) {
  std::pair<float, float> forget_time_1(lower_1, lower_2);
  std::pair<float, float> forget_time_2(upper_1, upper_2);
  uniface->forget(forget_time_1, forget_time_2, static_cast<bool>(reset_log));
}

void mui_forget_lower_upper_2fx_pair( mui_uniface_2fx* uniface, float lower_1, float lower_2, float upper_1, float upper_2, int reset_log ) {
  std::pair<float, float> forget_time_1(lower_1, lower_2);
  std::pair<float, float> forget_time_2(upper_1, upper_2);
  uniface->forget(forget_time_1, forget_time_2, static_cast<bool>(reset_log));
}

void mui_forget_lower_upper_2d_pair( mui_uniface_2d* uniface, double lower_1, double lower_2, double upper_1, double upper_2, int reset_log ) {
  std::pair<double, double> forget_time_1(lower_1, lower_2);
  std::pair<double, double> forget_time_2(upper_1, upper_2);
  uniface->forget(forget_time_1, forget_time_2, static_cast<bool>(reset_log));
}

void mui_forget_lower_upper_2dx_pair( mui_uniface_2dx* uniface, double lower_1, double lower_2, double upper_1, double upper_2, int reset_log ) {
  std::pair<double, double> forget_time_1(lower_1, lower_2);
  std::pair<double, double> forget_time_2(upper_1, upper_2);
  uniface->forget(forget_time_1, forget_time_2, static_cast<bool>(reset_log));
}

void mui_forget_lower_upper_2t_pair( mui_uniface_2t* uniface, double lower_1, double lower_2, double upper_1, double upper_2, int reset_log ) {
