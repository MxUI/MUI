...
Created: Feb 10, 2014
Author: Y. H. Tang
Description: A reference file for making custom samplers. The new sampler
             does not have to derive from this class, it just needs to
             implement all the interfaces with the signatures specified.
*/
