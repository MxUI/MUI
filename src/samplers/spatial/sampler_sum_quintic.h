...
/**
 * @file sampler_sum_quintic.h
 * @author Y. H. Tang
 * @date 10 February 2014
 * @brief Spatial sampler that provides a value at a point using summation
 * with a quintic kernel.
 */
...
public:
    ...
    sampler_sum_quintic( REAL r_ ) : r( r_ ), hinv( REAL( 3 ) / r_ )
    {
...
#endif /* MUI_SAMPLER_SUM_QUINTIC_H_ */
